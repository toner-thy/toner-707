...
<!-- 公共头部 -->
	...
	<div class="body_content">
	    ...
	    <h1>系统使用帮助</h1>
		    ...
		    <ul id="tree1" class="mini-tree" url="${ctx }/bmp/helptree/helpTree_loadTree.action" style="width:300px;height:600px;padding:5px;"
	    ...
	    <div id="rightContent" style="padding:5px;width: 78%;float: left;height: 600px;overflow: auto;">
	    	<iframe name="contentIframe" id="contentIframe" scrolling="auto" src="${ctx }/bmp/helptree/helpTree_content.action"
	    		height="98%" width="120%" frameborder="0"></iframe>
	    </div>
	</div>
</body>
</html>
