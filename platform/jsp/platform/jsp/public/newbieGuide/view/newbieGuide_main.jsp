	...
	<body>
		...
		<div id="body_content" class="body_content">
			<div class="tree">
				...
				<div id="district_tree_header" class="panel_header">
					...
					<div class="panel_title" style="float: right;">
						...
						<input id="district.districtCode" name="district.districtCode" type="hidden" value="${district.districtCode }">
					</div>
				</div>
				<!-- 内容 -->
			...
			<div class="tree_right_content">
				<iframe name="contentIframe" id="contentIframe" scrolling="auto" src="${ctx}/bmp/newbieGuide/newbieGuide_mainList.action?checkLower=1" height="100%" width="100%" frameborder="0"></iframe>
			</div>
		</div>
	</body>
</html>
<script type="text/javascript">
	...
	tree.addEvent('select',function(node){
		...
		$('district.districtCode').value = node.data.id;
		contentLoad("${ctx}/bmp/newbieGuide/newbieGuide_mainList.action?district.districtCode="+node.data.id+"&checkLower="+chkIncludeChild+"&_ts"+$time());
	});
	// 最后的10是上下边距和
	...
	function doChangeValue(value){
		if(value == 1){
			...
			contentLoad("${ctx}/bmp/newbieGuide/newbieGuide_mainList.action?district.districtCode="+$('district.districtCode').value+"&checkLower=0&_ts"+$time());
		} else {
			$('chkIncludeChild').value = 1;
			contentLoad("${ctx}/bmp/newbieGuide/newbieGuide_mainList.action?district.districtCode="+$('district.districtCode').value+"&checkLower=1&_ts"+$time());
		}
	}
</script>
</html>