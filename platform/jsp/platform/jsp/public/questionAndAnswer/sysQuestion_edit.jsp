		...
		<div id="body_content" class="body_content">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="add_form" action="<s:url namespace='/bmp/sysQuestion' action='sysQuestion_editing' includeParams='true'/>" method="post" enctype="multipart/form-data">
						<input type="hidden" name="sysQuestion.questionId" value="${sysQuestion.questionId }" />
						<input type="hidden" name="sysAnswer.answerId" value="${sysAnswer.answerId }" />
