	...
	<body style="background-color: white;">
		...
		<div id="body_content" class="body_content">
			...
			<div class="tree_right_content">
				<iframe name="contentIframe" id="contentIframe" scrolling="auto" src="${ctx}/bmp/statinfo/statinfo_mainList.action" height="100%" width="100%" frameborder="0"></iframe>
			</div>
		</div>
	</body>
</html>
<script type="text/javascript">
	...
	tree.addEvent('select',function(node){
		contentLoad("${ctx}/bmp/statinfo/statinfo_mainList.action?organ.district.districtCode="+node.data.id+"&_ts"+$time());
	});
	// 最后的10是上下边距和
