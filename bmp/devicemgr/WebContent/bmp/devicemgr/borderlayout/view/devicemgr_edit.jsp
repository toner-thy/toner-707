					...
					<form id="form1" class="form" action="<s:url action="deviceMgrAction_update"  includeParams="true"/>" method="post">
						...
						<table class="content_table">
							...
							<tr height="30px;">
								...
								<td>
									<organ:selectByDistrct  textEl="secrecyEquipment.obtainOrgan.organName" valueEl="secrecyEquipment.obtainOrgan.organId"  required="true" onlyFromValue="true"  buttonEl="organselected"
									 value="${secrecyEquipment.obtainOrgan.organId }" text="${secrecyEquipment.obtainOrgan.organName}"></organ:selectByDistrct>
								</td>
								<td align="right">
									责任人：
								</td>
