				...
				<form id="form1" class="form" action="<s:url action="equipmentTrash_updateTrash" includeParams="true"/>" method="post">
					<table id="edit-0" align="center" class="edit_table">	
						...
						<tr>
							...
							<td>
								<textarea rows="30" cols="80" name="equipmentTrash.applyReason" class="'length[1000]'">${equipmentTrash.applyReason}</textarea>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<textarea rows="30" cols="80" name="equipmentTrash.remark" class="'length[1000]'">${equipmentTrash.remark}</textarea>
							</td>
						</tr>
					</table>
					<div align="center">
