...
<html>
	<head>
		...
		<script language="javascript">
			...
			function doAudit(id)
			{
				window.location.href = 'equipmentLoan_addAuditLoan1.action?equipmentLoan.equipmentLoanId='+id;
			}
		...
		<div class="body_content">
			<div class="edit_content">
				...
				<div class="edit_query_bar">
					<s:form action="equipmentLoan_auditLoan1" id="secrecyEquipment_list_form" theme="simple">
						...
						<ec:row>
							...
							<ec:column property="null" title="审批">
								<A href='###' class="cpx12orange" onclick="doAudit('${equipmentLoan.equipmentLoanId }');">
									<img src="${pageContext.request.contextPath}/platform/theme/default/images/icon/reportshop.gif"
										order="0" alt="审批">
								</A>
							</ec:column>
						</ec:row>
