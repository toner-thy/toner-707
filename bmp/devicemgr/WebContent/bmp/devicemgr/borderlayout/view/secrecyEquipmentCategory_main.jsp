		...
		<div id="body_content">
			...
			<div class="tree">
				...
				<div id="tree_header" class="panel_header">
					<div class="panel_title">保密技术设备分类</div>
				</div>
				<!-- 树内容 -->
			...
			<div class="tree_right_content" style="border: 1px solid #B5CBD9;">
				<iframe name="contentIframe" id="contentIframe" scrolling="auto" name="secrecyEquipmentCategoryIframe" id="secrecyEquipmentCategoryIframe" scrolling="auto" src="${ctx}/bmp/secrecyEquipmentCategory/secrecyEquipmentCategory_edit.action?secrecyEquipmentCategory.secrecyEquipmentCategoryId=1" height="100%" width="100%" frameborder="0"></iframe>
			</div>
			<!-- 右侧内容结束 -->
		</div>
	</body>
...
<script type="text/javascript">
	...
	tree.load({
		url: '${ctx}/bmp/secrecyEquipmentCategory/secrecyEquipmentCategory_tree.action?times='+new Date().getTime()});
	tree.addEvent('select',function(node){
		contentLoad("${ctx}/bmp/secrecyEquipmentCategory/secrecyEquipmentCategory_edit.action?secrecyEquipmentCategory.secrecyEquipmentCategoryId="+node.data.id);
	});
