	...
	<body>
		<div id="body_content">
			...
			<div class="tree_right_content" style="border: 1px solid #B5CBD9;">
				<iframe name="contentIframe" id="contentIframe" scrolling="auto"  src="${ctx}/bmp/devicemgr/deviceMgrAction_list.action?secrecyEquipmentCategory.secrecyEquipmentCategoryId=1" height="100%" width="100%" frameborder="0"></iframe>
			</div>
			<!-- 右侧内容结束 -->
		</div>
	</body>
...
<script type="text/javascript">
	...
	tree.addEvent('select',function(node){
		contentLoad("${ctx}/bmp/devicemgr/deviceMgrAction_list.action?secrecyEquipmentCategory.secrecyEquipmentCategoryId="+node.data.id);
	});
