		...
		<div class="body_content">
			<div class="edit_content">
				...
				<div class="edit_query_bar">
					<s:form action="equipmentTrash_auditTrash" id="equipmentTrash_auditTrash" theme="simple">
			...
			<div class="edit_content">
				...
				<s:if test="#request.list.size>0">		
					<ec:table items="list" var="equipmentTrash" tableId="list" border="0"
						action="${pageContext.request.contextPath}/equipmentTrash_auditTrash.action"
...
<script language="javascript">
	...
	function doAudit(id)
	{
		window.location.href = 'equipmentTrash_addAuditTrash.action?equipmentTrash.equipmentTrashId='+id;
	}
