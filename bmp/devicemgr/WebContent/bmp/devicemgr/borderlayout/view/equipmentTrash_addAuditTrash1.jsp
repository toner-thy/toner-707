...
<html>
	<head>
		...
		<script type="text/javascript">
		    ...
		    function doCancel()
		    {
		    	window.location.href='<s:url action="equipmentTrash_auditTrash1" includeParams="false"/>';
		    }
		    ...
		    function doAudit(flag)
		    {
				...
				$('equipmentTrash_saveAuditTrash1').submit();
		    }
		</script>	
	...
	<body>
		...
		<div class="body_content">
			<div class="edit_content" >
				...
				<form id="equipmentTrash_saveAuditTrash1" class="form"
