	...
	<head>
		...
		<script type="text/javascript">
			...
			function addExistRow(i, t, n, p, l, g, ion){
				var managerTypeStr = "<select name='secretNetwork.secretNetworkManagerses["+rowNum+"].managerType' id='managerType_"+rowNum+"' ><option value='1'>网络管理员</option><option value='2'>安全管理员</option><option value='3'>安全审计员</option></select>";
				var str = "<input type='hidden' name='secretNetwork.secretNetworkManagerses["+rowNum+"].secretNetworkManagersId' value='"+ i +"' />"+managerTypeStr;
				var str1 = "<input type='text' name='secretNetwork.secretNetworkManagerses["+rowNum+"].managerName' size='15' id='mName_"+rowNum+"' value='"+ n +"' /><span style='color:red;'>&nbsp;&nbsp;*</span>";
				var str2 = "<input type='text' name='secretNetwork.secretNetworkManagerses["+rowNum+"].managerPost' size='15' id='mPost_"+rowNum+"' value='"+ p +"'/><span style='color:red;'>&nbsp;&nbsp;*</span>";
				var str3 = "<input type='text' name='secretNetwork.secretNetworkManagerses["+rowNum+"].learning' size='15' id='mLearn_"+rowNum+"' value='"+ l +"'/><span style='color:red;'>&nbsp;&nbsp;*</span>";
				var str4 = "<input type='text' name='secretNetwork.secretNetworkManagerses["+rowNum+"].graduateSchool' size='15' value='"+ g +"' id='mGraduate_"+rowNum+"'/><span style='color:red;'>&nbsp;&nbsp;*</span>";
				var str5 = "<select name='secretNetwork.secretNetworkManagerses["+rowNum+"].isParticipatedSecre' id='isParticipatedSecre_"+ion+"' style='width:50pt;'><option value='0'>否</option><option value='1'>是</option></select>";
				...
				tr.inject(table);
				$("managerType_"+rowNum).value=t;
				$("isParticipatedSecre_"+rowNum).value=ion;
			...
			function addRow(){
				...
				var str1 = "<input type='text' name='secretNetwork.secretNetworkManagerses["+rowNum+"].managerName' size='15' id='mName_"+rowNum+"'/><span style='color:red;'>&nbsp;&nbsp;*</span>";
