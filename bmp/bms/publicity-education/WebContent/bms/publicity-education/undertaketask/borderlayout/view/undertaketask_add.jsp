		...
		<div id="body_content" class="body_content">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="add_form" action="<s:url namespace='/bmp/undertaketask' action='undertaketask_adding' includeParams='true'/>" method="post">
						<table class="content_table" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl">
									<ui:multySelectByOrgan textEl="undertaker_name"  valueEl="undertaketask.undertaker" styleClass="width:100px;"
							...
							<tr>
								...
								<td class="tbValue fl">
									<sp:selectSecrecyPerson required="true" onlyFromValue="false" styleClass="validate['length[32]']" buttonEl="secrecyPersonName"
									 valueEl="undertaketask.projectLeader.userInfoId"
									 textEl="undertaketask.projectLeader.name"  ></sp:selectSecrecyPerson>
								</td>
							</tr>
