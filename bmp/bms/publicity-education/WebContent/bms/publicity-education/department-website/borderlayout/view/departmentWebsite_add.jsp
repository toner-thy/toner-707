		...
		<div id="body_content" class="body_content">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="add_form" action="<s:url namespace='/bmp/departmentWebsite' action='departmentWebsite_adding' includeParams='true'/>" method="post" enctype="multipart/form-data">
