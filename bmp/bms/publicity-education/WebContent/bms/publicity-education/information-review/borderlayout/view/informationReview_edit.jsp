						...
						<table class="content_table" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl">
									...
									value="${informationReview.undertakingDepartment.departmentId }"
									text="${informationReview.undertakingDepartment.departmentName }"
									 buttonEl="sss" />
								</td>
							</tr>
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:checkbox fieldCode="releaseWay" tableCode="bmp" name="releaseWays" optionValues="${informationReview.releaseWay}" />
								</td>
							</tr>
