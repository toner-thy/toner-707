						...
						<tr>
							...
							<td width="*" valign="top">
								...
								<div id="cp002"
									...
									<form method="post" id="queryform" action="${ctx }/bmp/annualPlanSelect/singelSelect.action">
										<table class="st" width="100%">
											...
											<tr>
												<td colspan="4" class="fc" style="border: 0px;">
													<div class="stBtnBar">
														<a class="pop_button" href="###" id="btn_query" name="btn_query"><span>查	询</span></a> <a class="pop_button"
			...
			<div class="panel_content panel_content_table">
				...
				<s:property value="request.dataList.size"/>
					<ec:table items="dataList" var="dataRow" tableId="dataList" border="0"
						...
						<ec:row>
							<ec:column property="annualPlanId" alias="annualPlanId_checkbox" cell="radio" headerCell="checkbox" width="5%"/>
							<ec:column property="null" title="年度工作计划标题" width="20%">
								<div title="${dataRow.annualPlanTitle }">${fn:substring(dataRow.annualPlanTitle,0,18)}<c:if test="${fn:length(dataRow.annualPlanTitle)>18}">...</c:if></div>
								<input type="hidden" name="name_${dataRow.annualPlanId }" id="name_${dataRow.annualPlanId }" value="${dataRow.annualPlanTitle }" />
							</ec:column>
