						...
						<tr>
							...
							<td width="*" valign="top">
								...
								<div id="cp002"
									...
									<form method="post" id="queryform" action="${ctx }/bmp/annualPlan/annualPlan_listQuery.action">
			...
			<div class="panel_header">
				<div class="panel_title panel_titleListIco">
					...
					<c:if test="${checkLower ne '1'}">
						${district.districtName}<dis:levelText district="${district}"></dis:levelText>级机关单位 - 年度工作计划列表
					</c:if>
					<c:if test="${checkLower eq '1'}">
						${district.districtName} - 年度工作计划列表
					</c:if>
				</div>
