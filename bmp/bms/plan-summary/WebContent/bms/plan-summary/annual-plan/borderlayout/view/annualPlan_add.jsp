		...
		<div id="body_content" class="body_content">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="add_form" action="<s:url namespace='/bmp/annualPlan' action='annualPlan_adding' includeParams='true'/>" method="post" enctype="multipart/form-data">
						<table class="content_table" width="100%">
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" name="annualPlan.annualPlanTitle" size="50" value="${annualPlan.annualPlanTitle }" class="validate['required','length[100]']"/><span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									<input type="text" name="annualPlan.annualPlanYear" readonly="readonly" class="Wdate validate['required']" value="${annualPlan.annualPlanYear }" onFocus="WdatePicker({dateFmt:'yyyy'})" />
						...
						<input type="hidden" id="annualPlan.annualPlanContentPre" name="annualPlan.annualPlanContentPre" value=""/>
					</form>
