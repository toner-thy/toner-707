	...
	<div class="body_content">
						...
						<tr>
							...
							<td width="*" valign="top">
								...
								<div id="cp002"
									...
									<form method="post" id="queryform" action="${ctx }/bmp/annualSummary/annualSummary_list.action">
										<table class="st" width="100%">
											<tr>
												<td class="tbLable fr">年度工作总结标题：</td>
		...
		<div class="panel tMargin">
			<div class="panel_header">
				<div class="panel_title panel_titleListIco">年度工作总结列表</div>
