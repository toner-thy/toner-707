		...
		<div id="body_content" class="body_content">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="add_form" action="<s:url namespace='/bmp/contactSecretPerson' action='contactSecretPerson_adding' includeParams='true'/>" method="post">
						<table class="content_table" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl" colspan="3">
									<ui:multySelectByOrgan   textEl="contactSecretPerson.undertakerName" valueEl="contactSecretPerson.undertaker" required="true" onlyFromValue="true" buttonEl="multiUndertaker"></ui:multySelectByOrgan>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl" colspan="3">
									<ui:multySelectByOrgan textEl="contactSecretPerson.approvedLeaderName" valueEl="contactSecretPerson.approvedLeader" required="true" onlyFromValue="true" buttonEl="multiLeader"></ui:multySelectByOrgan>
								</td>
							</tr>
						</table>
						<!-- 隐藏提交按钮 -->
