					...
					<form id="add_form" action="<s:url namespace='/bmp/receiveConfidential' action='receiveConfidential_editing' includeParams='true'/>" method="post">
						...
						<table class="content_table" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" readonly="readonly" name="receiveConfidential.receiverTime" value="<s:date name="receiveConfidential.receiverTime" format="yyyy-MM-dd"/>"  class="Wdate validate['required']" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/><span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
								<td class="tbLable fr">
									文号：
								</td>
