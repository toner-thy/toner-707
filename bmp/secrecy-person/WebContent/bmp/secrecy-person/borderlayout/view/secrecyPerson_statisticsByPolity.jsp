...
<script type="text/javascript">
function doExportCurrentPartPolity(){
		var districtCode;
		...
		window.location.href = "${ctx}/bmp/secrecyperson/secrecyPerson_exportCurrentPolity.action?districtCode=" + districtCode + "&countScope=${countScope}"  + "&_ts=" + $time();
}
</script>
		...
		<s:if test="#request.statisticsList.size>0">
				<div class="panel_header">
					...
					<div class="panel_btn_bar pop_button_bar">
						<c:if test="${expBtnFlag eq 'currentPart' }" >
							<a class="pop_button" href="###" onclick="doExportCurrentPartPolity()"><span>导出</span></a>
						</c:if>
					</div>
				</div>
				<div class="eXtremeTable" style="overflow: auto;">
					<table border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="30%">
						<thead>
							<tr>
								<td align="center" style="font-weight:bolder;color:black;" rowspan="2">政治面貌</td>
