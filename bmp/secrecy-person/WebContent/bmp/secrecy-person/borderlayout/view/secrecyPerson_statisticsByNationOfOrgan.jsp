...
function doExportNationOrgan(){
		...
		window.location.href = "${ctx}/bmp/secrecyperson/secrecyPerson_exportNationOrgan.action?districtCode=" + districtCode + "&countScope=${countScope}" + "&_ts=" + $time();
}
</script>
		...
		<s:if test="#request.nationStatisticsList.size>0">
				<div class="panel_header">
					...
					<div class="panel_btn_bar pop_button_bar">
						<a class="pop_button" href="###" onclick="doExportNationOrgan()"><span>导出</span></a>
					</div>
				</div>
