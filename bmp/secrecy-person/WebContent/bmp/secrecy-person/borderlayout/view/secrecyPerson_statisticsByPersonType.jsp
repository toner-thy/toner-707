...
function doExportCurrentPart(){
		...
		window.location.href = "${ctx}/bmp/secrecyperson/secrecyPerson_exportCurrentPersonType.action?districtCode=" + districtCode + "&countScope=${countScope}" + "&_ts=" + $time();
}
</script>
		...
		<s:if test="#request.statisticsList.size>0">
				...
				<div class="eXtremeTable" style="overflow: auto;">
					<table border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="30%">
						<thead>
							<tr>
								<td align="center" style="font-weight:bolder;color:black;" rowspan="2">人员类型</td>
