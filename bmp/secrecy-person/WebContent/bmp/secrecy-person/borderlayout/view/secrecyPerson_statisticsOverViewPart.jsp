...
function doExportCurrentPart(){
		...
		window.location.href = "${ctx}/bmp/secrecyperson/secrecyPerson_exportOverViewPart.action?districtCode=" + districtCode  + "&countScope=${countScope}" + "&_ts=" + $time();
}
</script>
	<!-- 内容开始 -->
				...
				<div class="eXtremeTable" style="overflow: auto;">
						<table border="0" cellspacing="0" cellpadding="0" class="tableRegion" width="100%" >
							<thead>
								<tr>
									<td align="center" >&nbsp;</td>
									<td colspan="4" class="tableHeader" style="font-weight:bolder;color:black;" align="center" >直辖单位</td>
									<td colspan="4" class="tableHeader" style="font-weight:bolder;color:black;" align="center" >行政区内</td>
								</tr>
								<tr height="36px;" class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
									<td class="tableHeader" style="font-weight:bolder;color:black;" align="center">名称</td>
