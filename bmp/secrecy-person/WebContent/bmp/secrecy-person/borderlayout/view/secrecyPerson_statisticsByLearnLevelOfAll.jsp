...
<script type="text/javascript">
//导出
function doExportLearnLevelDistrict(){
		var districtCode;
		...
		window.location.href = "${ctx}/bmp/secrecyperson/secrecyPerson_exportLearnLevelDistrict.action?districtCode=" + districtCode + "&countScope=${countScope}" + "&_ts=" + $time();
}
</script>
	<!-- 内容开始 -->
		<s:if test="#request.statisticsList.size>0">
				<div class="panel_header">
					...
					<div class="panel_btn_bar pop_button_bar">
						<a class="pop_button" href="###" onclick="doExportLearnLevelDistrict()"><span>导出</span></a>
					</div>
				</div>
				...
				<div class="eXtremeTable" style="overflow:auto; ">
					<table border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="30%">
						<thead>
							...
							<tr>
								<c:forEach var="option" items="${leaningLevelOptions }" >
							...
							<tr>
								<c:forEach var="leaningLevelMap" items="${leaningLevelOptions }" >
						...
						<tbody class="tableBody">
							...
							<c:forEach var="row" items="${statisticsList }" varStatus="rowStatu">
							<tr class="odd">
