				...
				<div class="panel_content panel_content_table">
					<table class="content_table st" cellspacing="0" cellpadding="0" width="100%;">
						...
						<tr>
							...
							<td class="tbValue fl">
								<input type="text" id="secrecyPerson.firstWorkDate" name="secrecyPerson.firstWorkDate"  class="Wdate" value="" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
							</td>
							<td class="tbLable fr">
								脱密时间止：
							</td>
