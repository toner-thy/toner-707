...
<script type="text/javascript">
//导出
function doExportAdminTechOrgan(){
		var districtCode;
		...
		window.location.href = "${ctx}/bmp/secrecyperson/secrecyPerson_exportAdminTechOrgan.action?districtCode=" + districtCode + "&countScope=${countScope}" + "&_ts=" + $time();
}
</script>
	<!-- 内容开始 -->
		...
		<s:if test="#request.statisticsList_admin.size>0">
				<div class="panel_header">
					...
					<div class="panel_btn_bar pop_button_bar">
						<a class="pop_button" href="###" onclick="doExportAdminTechOrgan()"><span>导出</span></a>
					</div>
				</div>
