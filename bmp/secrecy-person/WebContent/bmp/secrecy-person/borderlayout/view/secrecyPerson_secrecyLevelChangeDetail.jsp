...
<%-- 					<a class="print_pop_button pop_button_close" href="###" onclick="javascript:environment.dialog.close();"><span>退出本页</span></a>
 --%>
		...
		<div class="print_panel" style="border: 0px;">
			<div id="msg_list" url="${ctx}/bmp/secrecyperson/secrecyPerson_personSecrecyLevelChangeHis.action?secrecyPersonLevelChange.secrecyPersonLevelChangeId=${secrecyPersonLevelChange.secrecyPersonLevelChangeId}"></div>
		</div>
		<div id="person_msg" url="${ctx}/bmp/secrecyperson/secrecyPerson_personMsg.action?secrecyPerson.secrecyPersonId=${secrecyPersonLevelChange.secrecyPersonId.secrecyPersonId}"></div>
	</body>
</html>