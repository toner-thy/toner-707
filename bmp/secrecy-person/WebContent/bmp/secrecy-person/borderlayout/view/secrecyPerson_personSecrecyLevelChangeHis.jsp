		...
		<!-- 内容panel开始 -->
			<div class="panel tMargin bMargin">
				...
				<div class="panel_content panel_content_table">
					<s:if test="#request.secrecyPersonLevelChangeList.size>0">
						<table class="content_table" width="100%" >
							...
							<c:forEach items="${secrecyPersonLevelChangeList }" var="changes">
								<tr>
									...
									<td width="5%" align="left">
										<dictionary:text tableCode="bmp" fieldCode="secrecy_level_thing" optionValue="${changes.currentLevel}"></dictionary:text>
									</td>
