		...
		<script type="text/javascript">
			...
			$ENV.loader.loadJavaScript("${ctx}/resources/js/formcheck/1.4/formcheck.js",function(){
				$ENV.onDomReady(function(){
					...
					formcheck = new FormCheck('form_secrecyFullPartTime_save',{
								display:{
	 ...
	 <!-- 公共头部 -->
		...
		<!-- 内容panel开始 -->
	 		<div class="panel">
				...
				<form id="form_secrecyFullPartTime_save" class="form"  action="<s:url namespace='/bmp/secrecyFullPartTime' action='secrecyFullPartTime_save' includeParams='true'/>" method="post" enctype="multipart/form-data">
					<table class="content_table">
						<tr>
							...
							<tr style="display: none" id="secrecyFullPartTime.date">
								...
								<td class="tbValue fl">
									 <input readonly="readonly" onfocus="WdatePicker()" value="${secrecyFullPartTime.date}" name="secrecyFullPartTime.date">
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
