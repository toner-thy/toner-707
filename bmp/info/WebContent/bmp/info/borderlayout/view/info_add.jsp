					...
					<form id="info_add" name="info_add" action="<s:url action="info_adding" includeParams="true"/>" method="post" enctype="multipart/form-data">
						<table class="content_table">
							...
							<tr>
								...
								<td>
									<input type="text" id="info.infoTime" name="info.infoTime" value="${info.infoTime}" class="Wdate data_input" class="validate['required','length[100]']" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly" maxlength="50" style="width: 200px;height: 20px;"/> <font style="color:red;">*</font>
								</td>
							</tr>
							<tr>
					...
					<table class="content_table st" id="table_att_add" width="100%">
						...
						<tr>
							...
							<td class="fl" colspan="3">
								<attach:upload uploadBehavior="bmpUploadBehavior" applyForm="info_add" limit="2" applyName="attachmentIds" showTitle="false"/>
							</td>
						</tr>
					</table>
				</div>
