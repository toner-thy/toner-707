		...
		<script language="javascript">
			...
			$ENV.loader.loadJavaScript("${ctx}/resources/js/SimpleUI/SimpleUI.js", function(){
				$ENV.onDomReady(function(){
					...
					formcheck = new FormCheck('form_equipmentcheck_edit',{
						display:{
		...
		<div class="body_content">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="form_equipmentcheck_edit" class="form" action="<s:url namespace="/bmp/equipmentcheck" action="equipmentCheck_editing" includeParams="true"/>" method="post">
						<!-- 隐藏域 -->
						<input type="hidden" name="equipmentCheck.equipmentCheckId" value="${equipmentCheck.equipmentCheckId}" />
						...
						<table class="content_table">
							...
							<tr>
						 	...
						 	<tr>
								...
								<td align="left">
									<input type="text" id="time" name="equipmentCheck.checkTime" value='<fmt:formatDate pattern="yyyy-MM-dd" value="${equipmentCheck.checkTime}"/>'
									title="检查时间" class="Wdate ipt validate['required']" onFocus="WdatePicker({isShowClear:true,dateFmt:'yyyy-MM-dd',readOnly:true})" readonly="readonly" /> <span style="color:red;">*</span>
								</td>
							</tr>
						 	<tr>
								<td align="right">
						 	...
						 	<tr>
								...
								<td align="left">
									<%-- <input class="validate['required'] ipt" type="text" value="${equipmentCheck.checkOrgan.organName }" title="请选择" id="organName" readonly="readonly"/>
								 	<input type="hidden" name="equipmentCheck.checkOrgan.organId" value="${organId }" id="organId" />
								 	<span style="color:red;">*</span> --%>
								 	<%-- <organ:multySelect textEl="equipmentCheck.checkOrgan.organName" valueEl="equipmentCheck.checkOrgan.organId" onlyFromValue="true"
										required="true" buttonEl="selectcheckOrganName"
										value="${organId}" valueProperty="organId" textProperty="organName"/> --%>
								 	<organ:select textEl="equipmentCheck.checkOrgan.organName" valueEl="equipmentCheck.checkOrgan.organId" onlyFromValue="true"
										required="true" buttonEl="selectcheckOrganName"
										value="${organ.organId}" text="${organ.organName}"/>
								</td>
								<td align="right">
							 		检查人：
								</td>
								<td align="left">
									<%-- <input class="validate['required'] ipt" type="text" value="${equipmentCheck.checkPerson.userInfo.name }" title="请选择" id=userName readonly="readonly"/>
						 	...
						 	<tr>
								...
								<td align="left" colspan="3">
									<textarea name="equipmentCheck.checkContent" class="validate['length[300]']" style="width: 95%; height: 120px;">${equipmentCheck.checkContent}</textarea>
								</td>
						 	</tr>
						 	...
						 	<tr>
								...
								<td align="left" colspan="3">
									<textarea name="equipmentCheck.remark" class="validate['length[300]']" style="width: 95%; height: 100px;">${equipmentCheck.remark}</textarea>
								</td>
						 	</tr>
						</table>
