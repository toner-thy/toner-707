	...
	<head>
		...
		<script language="javascript">
			...
			window.addEvent('domready', function(){
				...
				formcheck = new FormCheck('form_equipmentType_add',{
					display:{
		...
		<div class="body_content">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="form_equipmentType_add" class="form" action="<s:url action='equipmentType_save' includeParams='true'/>" method="post">
						<table class="content_table">
							<tr>
								<td class="tbLable fr">装备配备类别名称：</td>
								<td class="tbValue fl">
									<input type="text" name="equipmentType.name" id="equipmentType.name" value="${equipmentType.name }" class="textInput validate['required','length[20]']" /> <font style="color:red;">*</font>
								</td>
							</tr>
							<tr>
