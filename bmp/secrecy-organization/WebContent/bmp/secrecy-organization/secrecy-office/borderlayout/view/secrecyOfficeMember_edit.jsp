		...
		<script type="text/javascript">
			...
			$ENV.loader.loadJavaScript("${ctx}/resources/js/formcheck/1.4/formcheck.js",function(){
				$ENV.onDomReady(function(){
					...
					$('secrecyOfficeMember.person.department.departmentName').addEvent('blur', doBlur);
				});
			});
			...
			var popFlag = true;
			function doBlur(){
				var value = $('secrecyOfficeMember.person.department.departmentName').value;
				if('${secrecyOfficeMember.person.department.departmentName}' != value){
					if(popFlag){
						doSelectDept();
						popFlag = false;
					}
			...
			function doSelectDept(){
				$ENV.dialog.open({
					title : '请选择',
					url : "${ctx}/bmp/secrecy-organization/secrecy-office/borderlayout/view/secrecyOfficeMember_deptConfirm.jsp?&_ts=" + $time(),
					width : window.top.getSize().x * 0.4,
					height : window.top.getSize().y * 0.3
				});
			}
			//显示层
			function disOne(id) {
		...
		<div id="body_content" class="body_content">
			...
			<div class="panel tMargin bMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="add_form" action="<s:url namespace='/secrecyorganization/secrecyofficemember' action='secrecyOfficeMember_editing.action' includeParams='true'/>" method="post">
						<!-- 隐藏域 -->
						<input type="hidden" name="secrecyOffice.secrecyOfficeId" value="${secrecyOffice.secrecyOfficeId}"/>
						<input type="hidden" name="secrecyOfficeMember.secrecyOfficeMemberId" value="${secrecyOfficeMember.secrecyOfficeMemberId}"/>
						...
						<table class="content_table st" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="nation" id="secrecyOfficeMember.person.nation" name="secrecyOfficeMember.person.nation" title="false" titleText="请选择" style="width: 130px;" optionValue="${secrecyOfficeMember.person.nation}"></dictionary:select>
								...
								<td class="tbValue fl">
									<input type="text" id="secrecyOfficeMember.person.birthDate" name="secrecyOfficeMember.person.birthDate" class="Wdate" value="<s:date name='secrecyOfficeMember.person.birthDate' format='yyyy-MM-dd'/>" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">学 历：</td>
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="learning_level" id="secrecyOfficeMember.person.learningLevel" name="secrecyOfficeMember.person.learningLevel" title="false" titleText="请选择" style="width: 130px;" optionValue="${secrecyOfficeMember.person.learningLevel}"></dictionary:select>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="specialty_code" styleClass="validate['required']" id="secrecyOfficeMember.person.specialtyCode" name="secrecyOfficeMember.person.specialtyCode" title="true" titleText="请选择" optionValue="${secrecyOfficeMember.person.specialtyCode }" style="width:130px;"></dictionary:select>
								</td>
								<td class="tbLable fr">政治面貌：</td>
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="polity" id="secrecyOfficeMember.person.polity" name="secrecyOfficeMember.person.polity" optionValue="${secrecyOfficeMember.person.polity }" style="width: 130px;"></dictionary:select>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="bmp" fieldCode="person_admin_level" styleClass="validate['required']" id="secrecyOfficeMember.person.administrativeLevel" name="secrecyOfficeMember.person.administrativeLevel" optionValue="${secrecyOfficeMember.person.administrativeLevel }" title="true" titleText="请选择" style="width: 130px;"></dictionary:select>
								</td>
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="technic_title_level" id="secrecyOfficeMember.person.technicTitleLevel" name="secrecyOfficeMember.person.technicTitleLevel" optionValue="${secrecyOfficeMember.person.technicTitleLevel }" style="width:130px;"></dictionary:select>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="bmp" fieldCode="sole_duty" id="secrecyOfficeMember.isSoleDuty" name="secrecyOfficeMember.isSoleDuty" optionValue="${secrecyOfficeMember.isSoleDuty }" style="width:130px;"></dictionary:select>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">其他职务：</td>
								<td class="tbValue fl">
									<input type="text" name="secrecyOfficeMember.person.duty" id="secrecyOfficeMember.person.duty" value="${secrecyOfficeMember.person.duty }" />
								</td>
							...
							<tr>
								...
								<td class="tbValue fl">
									...
									<input type="hidden" id="secrecyOfficeMember.oldDeptId" name="secrecyOfficeMember.oldDeptId" value="${secrecyOfficeMember.person.department.departmentId}">
								</td>
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="post_type" styleClass="validate['required']" id="secrecyOfficeMember.person.postType" name="secrecyOfficeMember.person.postType" title="true" titleText="请选择" style="width: 130px;" optionValue="${secrecyOfficeMember.person.postType}"></dictionary:select>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" id="secrecyOfficeMember.sort" name="secrecyOfficeMember.sort" value="${secrecyOfficeMember.sort }" class="validate['required','digit','length[11]']"/>&nbsp;&nbsp;<font color="red">*</font>
								</td>
							</tr>
							<tr>
