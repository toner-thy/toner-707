	...
	<head>
		...
		<script type="text/javascript">
			...
			function doView(districtCode, organName) {
				$ENV.dialog.open({
					title : '【' + organName + '】基础设施建设----详情',
					url : "${ctx}//secrecyorganization/secrecyofficestat/secrecyOfficeStat_statInfrastructure.action?districtCode=" + districtCode + "&flag=false&_ts=" + $time(),
