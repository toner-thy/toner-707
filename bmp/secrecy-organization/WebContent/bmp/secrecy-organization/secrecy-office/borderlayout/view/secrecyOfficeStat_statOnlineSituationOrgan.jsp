	...
	<head>
		...
		<script type="text/javascript">
			...
			function doView(districtCode, organName) {
				$ENV.dialog.open({
					title : '行政管理部门【' + organName + '】人员统计---在编人员详情',
					url : "${ctx}//secrecyorganization/secrecyofficestat/secrecyOfficeStat_statOnlineSituation.action?districtCode=" + districtCode + "&flag=false&_ts=" + $time(),
