...
function doExportAdminLevel(){
		...
		window.location.href = "${ctx}/secrecyorganization/secrecyWorkOrgan/secrecyOfficeStat_exportAdministrativeLevelDistrict.action?districtCode=" + districtCode + "&_ts=" + $time();
}
				...
				<div class="panel_header">
					...
					<div class="panel_btn_bar pop_button_bar">
						<c:if test="${expBtnFlag eq 'classifyDistrict' }">
							<a class="pop_button" href="###" onclick="doExportAdminLevel()"><span>导出</span></a>
						</c:if>
					</div>
				</div>
