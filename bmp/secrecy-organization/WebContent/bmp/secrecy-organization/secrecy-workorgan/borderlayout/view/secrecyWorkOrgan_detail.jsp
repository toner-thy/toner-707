...
<html>
		...
		<script type="text/javascript">
			...
			function doReport(){
				if(window.confirm("确定上报吗？")){
					var action = "${ctx}/secrecyorganization/secrecyWorkOrgan/secrecyWorkOrgan_report.action";
					window.location.href = action + '?secrecyWorkOrganIds=${secrecyWorkOrgan.secrecyWorkOrganId}&time=' + new Date().getTime();
				}
			}
	...
	<body>
		...
		<div class="button_bar">
			<div class="left">
				<div class="pop_button_bar">
					<a class="pop_button" href="###" onclick="javascript:doEdit();"><span>编 辑</span></a>
					<%-- <a class="pop_button" href="###" onclick="doReport()"><span>上 报</span></a> --%>
					<!-- <a class="pop_button" href="###" onclick=""><span>历届保密工作机构</span></a> -->
		...
		<div id="main_tab" class="panel tab_panel" style="height: 300px;">
				...
				<div class="panel_content" style="overflow: auto;">
					...
					<s:if test="#attr.secrecyWorkOrganRelationMemberList.size>0">
								<div class="eXtremeTable">
									<table class="tableRegion" cellspacing="0" cellpadding="0" width="98%;">
										<thead>
											<tr>
							...
							<table class="tableRegion" cellspacing="0" cellpadding="0" width="100%;">
								<thead>
									<tr>
										...
										<td class="tableHeader fc" width="20%">部 门</td>
										<td class="tableHeader fc" width="10%">行政职务</td>
