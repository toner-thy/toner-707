...
<html>
	<head>
		...
		function doDetail(){
			$ENV.dialog.open({
				url : '/bmp/bmp/secrecy-organization/secrecy-workorgan/borderlayout/view/secrecyWorkOrgan_gbtj_sub_sub1_detail_demo.jsp?t_date=' + new Date().getTime(),
				width : 0.8,
				height : 0.9,
				title : '详情'
			});
		...
		<div id="main_tab" class="panel tab_panel">
			<div id="main_tab_header" class="panel_header">
				<div class="tab_bar">
					...
					<div class="panel_title">省级机关明细</div>
				</div>
			</div>
			...
			<div class="panel_content panel_content_table">
				<div class="eXtremeTable" style="margin: 0px;">
					<table class="tableRegion" cellspacing="0" cellpadding="0" width="100%;">
						<thead>
							<tr>
								<td class="tableHeader fc" width="12%">单位名称</td>
								<td class="tableHeader fc" width="12%">详情</td>
							</tr>
						</thead>
						<tbody class="tableBody" >
							<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='even'">
								...
								<td class="fc">
									<a href="###" onclick="doDetail()"><img src="${ctx}/platform/theme/borderlayout/skin/blue/img/btn/display.gif" border="0" title="显示详情"/></a>
								</td>
							</tr>
