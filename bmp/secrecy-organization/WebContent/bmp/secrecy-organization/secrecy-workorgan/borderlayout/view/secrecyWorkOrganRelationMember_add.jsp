...
<html>
				...
				var jsonRequest = new Request.JSON({
 				    ...
 				    onComplete: function(result, text){
 				    	if (result.userName != null) {
 								...
 								$('secrecyWorkOrganRelationMember.person.duty').value = result.duty == null ? "" : result.duty ;
	...
	<body>
		...
		<div id="body_content" class="body_content">
			<!-- 复合面板开始 -->
			<%--
			<cp:start defaultTitle="单位保密工作机构成员简介" ctx="${ctx}" icoPath="/bmp/secrecy-organization/secrecy-workorgan/borderlayout/skin/blue/img/detail_cpIco.gif">
				<div id="cp001Btn" class="cpBtn_ov" href="###" onmouseover="javascript:showCp(1,'cp001','单位保密工作机构成员简介');">关 于</div>
			</cp:start>
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="add_form" action="<s:url namespace='/secrecyorganization/secrecyWorkOrganRelationMember' action='secrecyWorkOrganRelationMember_adding.action' includeParams='true'/>" method="post" enctype="multipart/form-data">
						<!-- 隐藏域 -->
						...
						<table class="content_table" width="100%">
							<tr>
								...
								<!-- demo 修改主任为保密办主任。。。正式修改时，请删除代码并修改字典表 -->
								<td class="tbValue fl">
									<select class="w135" name="secrecyWorkOrganRelationMember.personGroupPosition.personGroupPosition">
										<c:forEach items="${personGroupPositionList}" var="pgp">
											<option value="${pgp.personGroupPosition}">
												 <c:choose>
								...
								<td class="tbValue fl">
									<%-- <ui:selectByOrgan valueEl="secrecyWorkOrganRelationMember.person.userInfoId" textEl="secrecyWorkOrganRelationMember.person.name" required="true" onlyFromValue="false" value="${secrecyWorkOrganRelationMember.person.userInfoId }" text="${secrecyWorkOrganRelationMember.person.name }"></ui:selectByOrgan> --%>
									<ui:selectByOrgan valueEl="secrecyWorkOrganRelationMember.person.userInfoId" textEl="secrecyWorkOrganRelationMember.person.name" required="true" onlyFromValue="false" value="${secrecyWorkOrganRelationMember.person.userInfoId }" text="${secrecyWorkOrganRelationMember.person.name }" onSelect="setUserInfo" dataSelector="userInfoSelector" buttonEl="userInfoBtn"></ui:selectByOrgan>
								</td>
							<tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									<dep:selectByOrgan valueEl="secrecyWorkOrganRelationMember.person.department.departmentId" textEl="secrecyWorkOrganRelationMember.person.department.departmentName" required="true" onlyFromValue="false" value="${secrecyWorkOrganRelationMember.person.department.departmentId}" text="${secrecyWorkOrganRelationMember.person.department.departmentName}" buttonEl="departmentBtn"></dep:selectByOrgan>
								</td>
								<td class="tbLable fr">
									人员排序：
								</td>
								<td class="tbValue fl">
									<input type="text" name="secrecyWorkOrganRelationMember.sort" value="1" class="validate['required','digit','length[11]']" />
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="sex" id="secrecyWorkOrganRelationMember.person.sex" name="secrecyWorkOrganRelationMember.person.sex" optionValue="${secrecyWorkOrganRelationMember.person.sex }" style="width:130px;" ></dictionary:select>
								</td>
								<td class="tbLable fr">出生年月：</td>
								<td class="tbValue fl">
								<input type="text" id="secrecyWorkOrganRelationMember.person.birthDate" name="secrecyWorkOrganRelationMember.person.birthDate" class="validate['required'] Wdate validate['length[20]']" value="<s:date name='#attr.secrecyWorkOrganRelationMember.person.birthDate' format='yyyy-MM-dd'/>" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly"/>
								 <span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="polity" id="secrecyWorkOrganRelationMember.person.polity" name="secrecyWorkOrganRelationMember.person.polity" optionValue="${secrecyWorkOrganRelationMember.person.polity}" title="true" titleText="中共党员" titleTextValue="5" style="width:130px;"></dictionary:select>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="bmp" fieldCode="sole_duty" id="secrecyWorkOrganRelationMember.isSoleDuty" name="secrecyWorkOrganRelationMember.isSoleDuty"  optionValue="${secrecyWorkOrganRelationMember.isSoleDuty }" style="width:130px;" title="true" titleText="否" titleTextValue="0"></dictionary:select>
								</td>
								<td class="tbLable fr">
									联系座机电话：
								</td>
							...
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" id="secrecyWorkOrganRelationMember.person.mobile" name="secrecyWorkOrganRelationMember.person.mobile" class="validate['phone','length[20]'] "  value="${secrecyWorkOrganRelationMember.person.mobile }"/>
									<%-- <span style="color:red;">&nbsp;&nbsp;*</span> --%>
								</td>
							</tr>
							<tr>
