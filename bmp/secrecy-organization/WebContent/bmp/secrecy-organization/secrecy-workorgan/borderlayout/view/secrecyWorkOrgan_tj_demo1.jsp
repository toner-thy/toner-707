	...
	<body>
		...
		<div id="body_content" class="body_content" style="top:3px;">
			...
			<div class="tree_right_content">
				...
				<iframe name="contentIframe" id="contentIframe" scrolling="auto" src="/bmp/bmp/secrecy-organization/secrecy-workorgan/borderlayout/view/secrecyWorkOrgan_tj_sub_demo.jsp" height="100%" width="100%" frameborder="0">
...
<script type="text/javascript">
	...
	tree.addEvent('select',function(node){
		contentLoad("/bmp/bmp/secrecy-organization/secrecy-workorgan/borderlayout/view/secrecyWorkOrgan_tj_sub_demo.jsp");
	});
	// 最后的10是上下边距和
