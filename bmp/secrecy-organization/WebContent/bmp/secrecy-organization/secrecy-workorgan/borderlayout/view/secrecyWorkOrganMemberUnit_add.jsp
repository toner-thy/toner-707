		...
		<div id="body_content" class="body_content">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="add_form" action="<s:url namespace='/secrecyorganization/secrecyWorkOrganMemberUnit' action='secrecyWorkOrganMemberUnit_adding.action' includeParams='true'/>" method="post" enctype="multipart/form-data">
						<!-- 隐藏域 -->
						...
						<table class="content_table" width="100%">
							<tr>
								...
								<td class="tbValue fl">
									<ui:selectByOrgan valueEl="secrecyWorkOrganMemberUnit.person.userInfoId" textEl="secrecyWorkOrganMemberUnit.person.name" required="true" onlyFromValue="false" value="${secrecyWorkOrganMemberUnit.person.userInfoId }" text="${secrecyWorkOrganMemberUnit.person.name }" onSelect="setUserInfo" dataSelector="userInfoSelector" buttonEl="selectPersonBtn"></ui:selectByOrgan>
								</td>
								<td class="tbLable fr">
									部门：
								</td>
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="sex" id="secrecyWorkOrganMemberUnit.person.sex" name="secrecyWorkOrganMemberUnit.person.sex" title="true" styleClass="validate['required']" style="width:130px;"></dictionary:select>
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
								<td class="tbLable fr">出生年月：</td>
								<td class="tbValue fl">
									<input type="text" id="secrecyWorkOrganMemberUnit.person.birthDate" name="secrecyWorkOrganMemberUnit.person.birthDate" class="Wdate validate['required','length[20]']" value="<s:date name='#attr.secrecyWorkOrganMemberUnit.person.birthday' format='yyyy-MM-dd'/>" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly"/>
									 <span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="learning_level" id="secrecyWorkOrganMemberUnit.person.learningLevel" name="secrecyWorkOrganMemberUnit.person.learningLevel" title="true" styleClass="validate['required']" style="width:130px;"></dictionary:select>
									<span style="color:red;">&nbsp;&nbsp;*</span>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="polity" id="secrecyWorkOrganMemberUnit.person.polity" name="secrecyWorkOrganMemberUnit.person.polity" title="true" styleClass="validate['required']" style="width:130px;"></dictionary:select>
									<span style="color:red;">&nbsp;&nbsp;*</span>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="specialty_code" id="secrecyWorkOrganMemberUnit.person.specialtyCode" name="secrecyWorkOrganMemberUnit.person.specialtyCode"  title="true" styleClass="validate['required']" style="width:130px;"></dictionary:select>
									<span style="color:red;">&nbsp;&nbsp;*</span>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="bmp" fieldCode="person_admin_level" id="secrecyWorkOrganMemberUnit.person.administrativeLevel" name="secrecyWorkOrganMemberUnit.person.administrativeLevel" title="true" styleClass="validate['required']" style="width:130px;"></dictionary:select>
									<span style="color:red;">&nbsp;&nbsp;*</span>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="technic_title_level" id="secrecyWorkOrganMemberUnit.person.technicTitleLevel" name="secrecyWorkOrganMemberUnit.person.technicTitleLevel" title="true" styleClass="validate['required']" style="width:130px;"></dictionary:select>
									<span style="color:red;">&nbsp;&nbsp;*</span>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="bmp" fieldCode="sole_duty" id="secrecyWorkOrganMemberUnit.isSoleDuty" name="secrecyWorkOrganMemberUnit.isSoleDuty" title="true" styleClass="validate['required']" style="width:130px;"></dictionary:select>
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" name="secrecyWorkOrganMemberUnit.otherDuty" id="secrecyWorkOrganMemberUnit.otherDuty" />
								</td>
								<td class="tbLable fr">何时从事保密工作：</td>
								<td class="tbValue fl">
									<input type="text" id="secrecyWorkOrganMemberUnit.secrecyWorkStart" name="secrecyWorkOrganMemberUnit.secrecyWorkStart" class="Wdate validate['required','length[20]']" value="<s:date name='#attr.secrecyWorkOrganMemberUnit.secrecyWorkStart' format='yyyy-MM-dd'/>" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly"/>
								 	<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" name="secrecyWorkOrganMemberUnit.sort" value="1" class="validate['required','digit','length[11]']"/>&nbsp;&nbsp;<font color="red">*</font>
								</td>
								<td class="tbLable fr">
									&nbsp;
								</td>
