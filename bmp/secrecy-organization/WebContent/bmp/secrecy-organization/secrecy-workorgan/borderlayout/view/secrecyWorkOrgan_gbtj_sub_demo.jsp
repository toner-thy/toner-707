		...
		<div id="main_tab" class="panel tab_panel">
			<div id="main_tab_header" class="panel_header">
				<div class="tab_bar">
					...
					<div class="panel_title">按学历统计</div>
			...
			<div class="tab_panel_content">
				<div class="panel_content" >
					<iframe name="xx" width="100%" height="100%" src="/bmp/bmp/secrecy-organization/secrecy-workorgan/borderlayout/view/secrecyWorkOrgan_gbtj_sub_sub1_demo.jsp"></iframe>
				</div>
				<div class="panel_content" >
					<iframe name="yy" width="100%" height="100%" src="/bmp/bmp/secrecy-organization/secrecy-workorgan/borderlayout/view/secrecyWorkOrgan_gbtj_sub_sub2_demo.jsp"></iframe>
				</div>
				<div class="panel_content" >
					<iframe name="ZZ" width="100%" height="100%" src="/bmp/bmp/secrecy-organization/secrecy-workorgan/borderlayout/view/secrecyWorkOrgan_gbtj_sub_sub3_demo.jsp"></iframe>
				</div>
				<div class="panel_content panel_content_table">
					<iframe name="ee" width="100%" height="100%" src="/bmp/bmp/secrecy-organization/secrecy-workorgan/borderlayout/view/secrecyWorkOrgan_gbtj_sub_sub4_demo.jsp"></iframe>
				</div>
				<div class="panel_content panel_content_table">
					<iframe name="ee" width="100%" height="100%" src="/bmp/bmp/secrecy-organization/secrecy-workorgan/borderlayout/view/secrecyWorkOrgan_gbtj_sub_sub5_demo.jsp"></iframe>
				</div>
				<div class="panel_content panel_content_table">
					<iframe name="ee" width="100%" height="100%" src="/bmp/bmp/secrecy-organization/secrecy-workorgan/borderlayout/view/secrecyWorkOrgan_gbtj_sub_sub6_demo.jsp"></iframe>
				</div>
			</div>
		</div>
	</body>
