...
<%-- 					<div class="panel_title" style="margin-left: 40px; margin-top: 5px;"><a class="pop_button" href="###" onclick="doReport()"><span>批量上报</span></a></div> --%>
				</div>
				<!-- 内容 -->
				<div id="district_tree" class="panel_content"></div>
			</div>
			<div class="tree_right_content">
				<iframe name="contentIframe" id="contentIframe" scrolling="auto" src="${ctx}/secrecyorganization/secrecycommittee/secrecyCommittee_list.action" height="100%" width="100%" frameborder="0"></iframe>
			</div>
		</div>
	</body>
</html>
<script type="text/javascript">
	...
	tree.addEvent('select',function(node){
		contentLoad("${ctx}/secrecyorganization/secrecycommittee/secrecyCommittee_list.action?district.districtCode="+node.data.id+"&_ts"+$time());
	});
	// 最后的10是上下边距和
