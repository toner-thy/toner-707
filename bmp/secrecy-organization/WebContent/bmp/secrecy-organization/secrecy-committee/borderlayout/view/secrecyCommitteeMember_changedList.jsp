		...
		<div class="">
			...
			<div class="panel tMargin bMargin">
				...
				<div class="panel_content panel_content_table">
					<s:if test="#request.secrecyCommitteeMembersChangeList.size>0">
						<ec:table items="secrecyCommitteeMembersChangeList" var="scmc" tableId="secrecyCommitteeMemberChangeTable" border="0"
							action="${ctx}/secrecyorganization/secrecycommitteemember/secrecyCommitteeMember_changedList.action"
							...
							<ec:row>
								...
								<ec:column property="null" title="变动事由" width="10%">
									<dictionary:text tableCode="bmp" fieldCode="personnel_changes" optionValue="${scmc.changeType }" ></dictionary:text>
								</ec:column>
