...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			// 返回方法
			function doBackList(){
				window.location.href = "${ctx}/secrecyorganization/secrecycommittee/secrecyCommittee_edit.action?secrecyCommittee.secrecyCommitteeId=${secrecyCommitteeMember.secrecyCommittee.secrecyCommitteeId}";
			}
			//显示层
			function disOne(id) {
				$(id).style.display="";
					...
					<form id="edit_form" action="<s:url namespace='/secrecyorganization/secrecycommitteemember' action='secrecyCommitteeMember_editing.action' includeParams='true'/>" method="post" enctype="multipart/form-data">
						...
						<table class="content_table" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl">
									<select style="width:130px;" name="secrecyCommitteeMember.personGroupPosition.personGroupPosition">
										<c:forEach items="${personGroupPositionList}" var="pgp">
											<option value="${pgp.personGroupPosition}"<c:if test="${pgp.personGroupPosition==secrecyCommitteeMember.personGroupPosition.personGroupPosition}"> selected="selected"</c:if>>${pgp.positionName}</option>
										</c:forEach>
									</select>
								</td>
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									<input type="text" name="secrecyCommitteeMember.person" id="secrecyCommitteeMember.person" value="${secrecyCommitteeMember.person }" class="validate['required','length[20]']">
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="sex" id="secrecyCommitteeMember.sex" name="secrecyCommitteeMember.sex" optionValue="${secrecyCommitteeMember.sex }" style="width:130px;"></dictionary:select>
								</td>
								<td class="tbLable fr">
									行政职务：
								</td>
							...
							<tr>
								...
								<td class="tbValue fl">
									...
									<dictionary:select tableCode="person" fieldCode="nation" id="secrecyCommitteeMember.nation" name="secrecyCommitteeMember.nation" optionValue="${secrecyCommitteeMember.nation }" style="width:130px;"/>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="learning_level" id="secrecyCommitteeMember.educationBackground" name="secrecyCommitteeMember.educationBackground" optionValue="${secrecyCommitteeMember.educationBackground }" style="width:130px;"></dictionary:select>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="degree" id="secrecyCommitteeMember.degree" name="secrecyCommitteeMember.degree" optionValue="${secrecyCommitteeMember.degree }" style="width:130px;"></dictionary:select>
								</td>
								<td class="tbLable fr">政治面貌：</td>
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="polity" id="secrecyCommitteeMember.politicalStatus" name="secrecyCommitteeMember.politicalStatus" optionValue="${secrecyCommitteeMember.politicalStatus }" style="width:130px;"></dictionary:select>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="specialty_code" id="secrecyCommitteeMember.major" name="secrecyCommitteeMember.major" optionValue="${secrecyCommitteeMember.major }" style="width:130px;"></dictionary:select>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="technic_title_level" id="secrecyCommitteeMember.technicalTitle" name="secrecyCommitteeMember.technicalTitle" optionValue="${secrecyCommitteeMember.technicalTitle }" style="width:130px;"></dictionary:select>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="bmp" fieldCode="person_admin_level" id="secrecyCommitteeMember.administrativeLevel" name="secrecyCommitteeMember.administrativeLevel" optionValue="${secrecyCommitteeMember.administrativeLevel }" style="width:130px;"></dictionary:select>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
							...
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" id="secrecyCommitteeMember.departmentName" name="secrecyCommitteeMember.departmentName" value="${secrecyCommitteeMember.departmentName }" class="validate['required','length[100]']"/>
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
								 -->
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="bmp" fieldCode="sole_duty" id="secrecyCommitteeMember.isSoleDuty" name="secrecyCommitteeMember.isSoleDuty" optionValue="${secrecyCommitteeMember.isSoleDuty }" style="width:130px;"></dictionary:select>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									<input type="text" name="secrecyCommitteeMember.sort" id="secrecyCommitteeMember.sort" value="${secrecyCommitteeMember.sort}" class="validate['required','digit','length[11]']"/>
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
								<td colspan="2">&nbsp;</td>
							</tr>
							<tr>
								...
								<td class="tbValue fl" colspan="3">
									<textarea id="secrecyCommitteeMember.otherDuty" name="secrecyCommitteeMember.otherDuty" style="width: 90%;height: 100px;" class="validate['length[1000]']">${secrecyCommitteeMember.otherDuty }</textarea>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
