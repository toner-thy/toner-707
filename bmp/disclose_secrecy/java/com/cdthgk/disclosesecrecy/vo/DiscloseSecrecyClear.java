 ...
 */
public class DiscloseSecrecyClear implements java.io.Serializable {
	...
	private String disclosesecrecyClearId;//要害部位  密级解除

	private DiscloseSecrecy disclosesecrecycaseId;
	 ...
	 * 默认构函数
	 */
	public DiscloseSecrecyClear() {
	}


	public String getDisclosesecrecyClearId() {
		return disclosesecrecyClearId;
	}


	public void setDisclosesecrecyClearId(String disclosesecrecyClearId) {
		this.disclosesecrecyClearId = disclosesecrecyClearId;
	}
