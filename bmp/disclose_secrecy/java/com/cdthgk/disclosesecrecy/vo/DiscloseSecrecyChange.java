 ...
 */
public class DiscloseSecrecyChange implements java.io.Serializable {
	...
	private String discloseSecrecyChangeId; //泄密事件密级变更id

	private  DiscloseSecrecy disclosesecrecycaseId; //泄密事件id
	 ...
	 * 默认构函数
	 */
	public DiscloseSecrecyChange() {

	}



	public String getDiscloseSecrecyChangeId() {
		return discloseSecrecyChangeId;
	}



	public void setDiscloseSecrecyChangeId(String discloseSecrecyChangeId) {
		this.discloseSecrecyChangeId = discloseSecrecyChangeId;
	}



	public DiscloseSecrecy getDisclosesecrecycaseId() {
		return disclosesecrecycaseId;
	}



	public void setDisclosesecrecycaseId(DiscloseSecrecy disclosesecrecycaseId) {
