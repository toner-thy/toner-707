	...
	<head>
		...
		<script type="text/javascript">
				...
				$ENV.onDomReady(function(){
					...
					if (needReload) {
						if (!confirm('新增成功，是否继续添加？')){
							...
							needReload2 = true;
							window.location.href = "${ctx}/bmp/caseCriticalviolation/caseCriticalviolation_edit.action?caseCriticalviolation.caseCriticalviolationId=${caseCriticalviolation.caseCriticalviolationId}";
						}
					};
			...
			function doBackList(id){
				window.location.href = "${ctx}/bmp/caseCriticalviolation/caseCriticalviolation_edit.action?caseCriticalviolation.caseCriticalviolationId="+id;
			}
		...
		<div class="button_bar">
			<div class="left">
				<div class="pop_button_bar">
					...
					<a class="pop_button" href="javascript:doBackList('${caseCriticalviolation.caseCriticalviolationId}');"><span>返回列表</span></a>
				</div>
			</div>
			<div class="right">
				<div class="pop_button_bar">
			...
			<div class="panel tMargin bMargin">
				<div class="panel_header">
					<div class="panel_title panel_titleListIco">
						严重违规案件【${caseCriticalviolation.name}】 ─ 新增处理责任人
					</div>
				</div>

				<div class="panel_content panel_content_table">
					<form id="form_partSecrecyPerson_add" action="<s:url namespace='/bmp/caseCriticalviolation/' action='caseHandledutyPerson_adding.action' includeParams='true'/>" method="post">
						<!-- 隐藏域 -->
						<input id="caseCriticalviolation.caseCriticalviolationId" name="caseCriticalviolation.caseCriticalviolationId" value="${caseCriticalviolation.caseCriticalviolationId}" type="hidden">
						<input id="caseCriticalviolation.name" name="caseCriticalviolation.name" value="${caseCriticalviolation.name}" type="hidden">
						<table class="content_table st" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl">
								<dictionary:select tableCode="bmp" fieldCode="organ_admin_level" id="caseHandledutyPerson.manageLevel" name="caseHandledutyPerson.manageLevel" title="false" titleText="请选择" style="width: 130px;"></dictionary:select>
								</td>
								<td class="tbLable fr">处理形式：</td>
								<td class="tbValue fl">
									<dictionary:select tableCode="bmp" fieldCode="bmp_handleType" id="caseHandledutyPerson.handleType" name="caseHandledutyPerson.handleType" title="false" titleText="请选择" style="width: 130px;"></dictionary:select>
								<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
							...
							<tr>
								...
								<td class="tbValue fl">
									<dictionary:select tableCode="person" fieldCode="polity" id="caseHandledutyPerson.politicalLandscape" name="caseHandledutyPerson.politicalLandscape" title="false" titleText="请选择" style="width: 130px;"></dictionary:select>
								 <img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
								...
								<td class="tbValue fl">
								 <dep:selectByOrgan valueEl="caseHandledutyPerson.department.departmentId"
									textEl="caseHandledutyPerson.department.departmentName" required="true" onlyFromValue="false"
