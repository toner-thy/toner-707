...
<c:set var="ctx" value="${pageContext.request.contextPath}"/>
		...
		<script type="text/javascript">
			...
			//导出
			function doyichajieExport() {
				window.location.href="${ctx}/bmp/discloseSecrecy/bendanwei_exportExcel_dealResult.action?organId=${organId}&&className=${className}&&dealResult=1";
			}
			...
			<div class="panel tMargin">
				<div class="panel_header">
					...
					<div class="panel_btn_bar pop_button_bar">
						<a href="###" id="doExport"  onclick="doyichajieExport()" class="pop_button"><span>导出</span></a>
					</div>
				</div>
