			...
			<div class="panel tMargin bMargin">
				<div class="panel_header">
					<div class="panel_title panel_titleListIco">
						严重违规案件【${caseHandledutyPerson.caseCriticalviolation.name}】 ─ 编辑处理责任人
					</div>
				</div>

				<div class="panel_content panel_content_table">
					<form id="form_partSecrecyPerson_add" action="<s:url namespace='/bmp/caseCriticalviolation/' action='caseHandledutyPerson_editing.action' includeParams='true'/>" method="post">
						<!-- 隐藏域 -->
