...
<script type="text/javascript">
	...
	//导出
	function dobaomijuExportDutyPerson() {
		window.location.href = "${ctx}/bmp/discloseSecrecy/baomiju_exportExcel_dutyPerson.action?dealResult=${dealResult}&&className=${className}&&districtCode=${districtCode}&&districtName=${districtName}";
	}
</script>
		...
		<div class="panel_header">
			...
			<div class="panel_btn_bar pop_button_bar">
				<s:if
					...
					<a href="###" id="doExport" onclick="dobaomijuExportDutyPerson()"
