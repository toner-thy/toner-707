			...
			<div class="panel tMargin bMargin">
				<div class="panel_header">
					<div class="panel_title panel_titleListIco">
						泄密事件【${discloseSecrecy.name}】 ─ 新增处理责任人
					</div>
				</div>

				<div class="panel_content panel_content_table">
					<form id="form_partSecrecyPerson_add" action="<s:url namespace='/bmp/discloseSecrecy/' action='caseHandledutyPerson_adding.action' includeParams='true'/>" method="post">
						<!-- 隐藏域 -->
						<input id="discloseSecrecy.disclosesecrecycaseId" name="discloseSecrecy.disclosesecrecycaseId" value="${discloseSecrecy.disclosesecrecycaseId}" type="hidden">
						<input id="discloseSecrecy.name" name="discloseSecrecy.name" value="${discloseSecrecy.name}" type="hidden">
							...
							<tr>
								...
								<td class="tbValue fl">
								 <dep:selectByOrgan valueEl="caseHandledutyPerson.department.departmentId"
									...
									styleClass="validate['length[32]']"  buttonEl="sss" />
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
