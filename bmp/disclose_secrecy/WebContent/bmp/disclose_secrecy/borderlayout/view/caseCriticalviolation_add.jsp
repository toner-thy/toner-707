	...
	<div id="body_content" class="body_content" style="width: 99%;">
		...
		<div class="panel tMargin">
			<div class="panel_header">
				<div class="panel_title panel_titleListIco">严重违规案件新增</div>
			...
			<div class="panel_content panel_content_table">
				...
				<form id="add_form"
					action="<s:url namespace='/bmp/caseCriticalviolation' action='caseCriticalviolation_adding.action' includeParams='true'/>"
					...
					<table class="content_table">
						...
						<tr>
							...
							<td class="tbValue fl"><dep:selectByOrgan valueEl="caseCriticalviolation.department.departmentId"
							...
							<td class="tbValue fl"><dictionary:select tableCode="bmp"
									...
									name="caseCriticalviolation.caseType" style="width: 200px;"/></td>
						</tr>
						<tr>
							...
							<td class="tbValue fl"><dictionary:select tableCode="bmp"
									...
									name="caseCriticalviolation.dutyOrganKind" style="width: 200px;" /></td>
						...
						<tr>
							...
							tableCode="bmp" fieldCode="secrecy_level_thing"
									 id="caseCriticalviolation.secrecyLevel"
									name="caseCriticalviolation.secrecyLevel" style="width: 132px;"/></td>
