...
<script type="text/javascript">
	...
	//导出(保密局)
	function doyichajieDistrictExport() {
		window.location.href = "${ctx}/bmp/discloseSecrecy/baomiju_exportExcel_dealResult.action?dealResult=1&&className=${className}&&districtCode=${districtCode}&&districtName=${districtName}";
	}
	//导出（直辖单位）
		...
		<div class="panel_header">
			...
			<div class="panel_btn_bar pop_button_bar">
				...
				<s:if test="#request.baomiju!=null">
					<a href="###" id="doExport" onclick="doyichajieDistrictExport()"
						class="pop_button"><span>导出</span></a>
				</s:if>
			</div>
		</div>
