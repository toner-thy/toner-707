		...
		<script type="text/javascript">
			...
			$ENV.loader.loadJavaScript("${ctx}/resources/js/formcheck/1.4/formcheck.js",function(){
				$ENV.onDomReady(function(){
					...
					formcheck = new FormCheck('form_meetingCategory_add',{
						display:{
							showErrors:1
						},
						trimValue: true
			...
			//返回
			function doBack(){
				window.location.href="meetingCategory_list.action";
			}
		...
		<div id="body_content" class="body_content">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="form_meetingCategory_add" class="form" action="<s:url action="meetingCategory_add"  includeParams="true"/>" method="post">
