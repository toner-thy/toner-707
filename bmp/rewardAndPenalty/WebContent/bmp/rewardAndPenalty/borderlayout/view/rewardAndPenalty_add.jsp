		...
		<script type="text/javascript">
			...
			$ENV.loader.loadJavaScript("${ctx}/resources/js/formcheck/1.4/formcheck.js",function(){
				$ENV.onDomReady(function(){
					...
					formcheck = new FormCheck('form_rewardAndPenalty_save',{
								display:{
	 ...
	 <!-- 公共头部 -->
		...
		<!-- 内容panel开始 -->
	 		<div class="panel">
				...
				<form id="form_rewardAndPenalty_save" class="form"  action="<s:url namespace='/bmp/rewardAndPenalty' action='rewardAndPenalty_save' includeParams='true'/>" method="post" enctype="multipart/form-data">
					<table class="content_table">
						<tr>
						    <td class="tbLable fr">日期：</td>
						    <td colspan="3">
						    <input name="rewardAndPenalty.date" value="${rewardAndPenalty.date }" class="Wdate validate['required']" onFocus="WdatePicker()" readonly="readonly"/><span style="color:red;">&nbsp;&nbsp;*</span>
							</td>
						</tr>
						<tr>
							<td class="tbLable fr">事项（人员）名称：</td>
							<td colspan="3">
								<input name="rewardAndPenalty.name" style="width:95%;"  type="text" value="${rewardAndPenalty.name}" class="validate['required','length[100]']"><span style="color:red;">&nbsp;&nbsp;*</span>
							</td>
						</tr>

						<Tr>
							<td class="tbLable fr">奖励情况：</td>
							<td class="tbValue fl">
