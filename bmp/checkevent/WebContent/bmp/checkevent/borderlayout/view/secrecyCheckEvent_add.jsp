		...
		<script type="text/javascript">
			...
			$ENV.loader.loadJavaScript("${ctx}/resources/js/formcheck/1.4/formcheck.js",function(){
				$ENV.onDomReady(function(){
					...
					formcheck = new FormCheck('form_secrecyCheckEvent_save',{
								display:{
	 ...
	 <!-- 公共头部 -->
		...
		<!-- 内容panel开始 -->
	 		<div class="panel">
				...
				<form id="form_secrecyCheckEvent_save" class="form"  action="<s:url namespace='/bmp/secrecyCheckEvent' action='secrecyCheckEvent_save' includeParams='true'/>" method="post" enctype="multipart/form-data">
					<table class="content_table">
						...
						<tr height="36px;">
						    ...
						    <td>
						    	<input name="secrecyCheckEvent.eventDate" value="${secrecyCheckEvent.eventDate }" class="Wdate validate['required']" onFocus="WdatePicker()" readonly="readonly"/><span style="color:red;">&nbsp;&nbsp;*</span>
							</td>
				...
				<div>
					<attach:upload uploadBehavior="bmpUploadBehavior" applyForm="form_secrecyCheckEvent_save"  applyName="secAttach" showTitle="false"/>
				</div>
			</div>
			</div>
		</div>
