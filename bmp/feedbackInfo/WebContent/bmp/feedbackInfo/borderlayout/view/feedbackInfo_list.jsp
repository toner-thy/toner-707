		...
		<div class="button_bar">
			<div class="left">
				<div class="pop_button_bar">
					<%-- <a id="edit" name="edit" class="pop_button" href="javascript:doEdit('${ctx}/platform/feedbackInfo/feedbackInfo_edit.action')"><span>意见处理</span></a> --%>
					<ap:operationbutton />
				</div>
			</div>
			<div class="right">
		...
		<div id="body_content" class="body_content">
			...
			<cp:start defaultTitle="意见反馈简介" ctx="${ctx}" icoPath="/bmp/feedbackInfo/borderlayout/skin/blue/img/list_cpIco.gif">
				...
				<cp:search show="true" divId="cp002">
					<s:form action="feedbackInfo_list" id="feedback_list_form" name="feedback_list_form" theme="simple">
						<table class="st" width="100%">
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" id="feedbackInfo.createPerson.userName" name="feedbackInfo.createPerson.userName" value="${feedbackInfo.createPerson.userName}"/>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									<input type="text" id="feedbackInfo.organ.organName" name="feedbackInfo.organ.organName" value="${feedbackInfo.organ.organName}"/>
								</td>
							</tr>
							<tr>
					...
					<s:if test="#request.feedbackInfoList.size>0">
						<ec:table items="feedbackInfoList" var="feedbackInfo" tableId="feedbackInfoList" border="0"
							...
							<ec:row>
								...
								<ec:column property="createPerson.userName" title="创建人" width="10%"/>
								<ec:column property="organ.organName" title="所在单位" width="15%"/>
								<ec:column property="createTime" cell="date" format="yyyy-MM-dd" title="创建时间" width="15%"/>
								<ec:column property="null" title="状 态" width="10%">
