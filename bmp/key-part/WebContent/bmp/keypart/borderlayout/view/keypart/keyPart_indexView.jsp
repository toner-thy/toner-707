...
<html>
	<head>
		...
		<script type="text/javascript">
 			...
 			function doPartView(id,secrecyLevel){
 				var titleText = "保密要害部位撰取-列表";
 				if(secrecyLevel=="-1") {
 					titleText = "保密要害部位合计-列表";
 				}
 				TabUtil.openAsTab({
 					url : '${ctx}/bmp/part/part_organPartData.action?id='+id+'&secrecyLevel='+secrecyLevel+'&t_date='+ new Date().getTime(),
 					title : titleText
 				});
 			}
									...
									<tr>
										...
										<td class="td_content_right">
											...
											<c:if test="${keyPartArgs[2] ne 0}">
												<a href="###" onclick="doPartView('${organ.organId}','3')">
													${keyPartArgs[2]}
												</a>
											</c:if>
										</td>
									...
									<tr>
										...
										<td class="td_content_right">
											...
											<c:if test="${keyPartArgs[1] ne 0}">
												<a href="###" onclick="doPartView('${organ.organId}','2')">
													${keyPartArgs[1]}
												</a>
											</c:if>
										</td>
									...
									<tr>
										...
										<td class="td_content_right">
											...
											<c:if test="${keyPartArgs[0] ne 0}">
												<a href="###" onclick="doPartView('${organ.organId}','1')">
													${keyPartArgs[0]}
												</a>
											</c:if>
										</td>
