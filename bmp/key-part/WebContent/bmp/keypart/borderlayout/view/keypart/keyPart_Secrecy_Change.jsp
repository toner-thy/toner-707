...
<html>
	...
	<body style="overflow:auto;overflow-x: hidden;">
		...
		<div class="panel tMargin" >
			<div class="panel_content panel_content_table">
				<form id="keyPart_change_form" action="<s:url namespace='/bmp/part' action='part_changeing.action' includeParams='true'/>"
					...
					<table class="content_table st" cellspacing="0" cellpadding="0" width="100%;">
						<tr>
							...
							<td class="tbValue fl">
							    ...
							    <input type="hidden" id="keyPartChange.beforeLevel" name="keyPartChange.beforeLevel" value="${keyPartChange.beforeLevel}" />
								<input type="hidden" id="keyPartChange.keyPartId.partId" name="keyPartChange.keyPartId.partId" value="${keyPartChange.keyPartId.partId}" />
							</td>
						</tr>
						...
						<tr>
							...
							<td class="tbValue fl">
								...
								optionValue="${keyPartChange.afterLevel}" title="false" style="width:130px;"></dictionary:select>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="tbValue fl">
								<input type="text" id="keyPartChange.changeDate" name="keyPartChange.changeDate" class="Wdate validate['length[20]'] w130"
						...
						<tr>
							...
							<td class="tbValue fl">
								<textarea rows="5" cols="70" id="keyPartChange.changeReason" name="keyPartChange.changeReason" ></textarea>
							</td>
						</tr>
	...
	function save(){
		...
		var yuan_mi_ji = document.getElementById("keyPartChange.beforeLevel").value;
		var xian_mi_ji = document.getElementById("keyPartChange.afterLevel").value;
		...
		//验证时间
		var cdate = document.getElementById("keyPartChange.changeDate").value;
		if(cdate=="") {
			alert("变更时间不能为空");
			return;
		}
		...
		//变更原因
		var changeReason = $("keyPartChange.changeReason").value;
		...
		//提交
		var frm = document.getElementById("keyPart_change_form");
		frm.submit();
	}
