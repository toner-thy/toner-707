...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			// 返 回
			function doBackToKeyPartDetail(id){
				window.location.href="${ctx}/bmp/part/part_detail.action?part.partId="+id;
			}
		</script>
	...
	<body>
		...
		<div class="print_but_bar no_print">
			...
			<div class="right no_print">
				<div class="print_pop_button no_print">
					<a class="print_pop_button" href="###" onclick="doBackToKeyPartDetail('${part.partId}')"><span>返 回</span></a>
				</div>
			</div>
		</div>

		<div class="print_panel">
			<div class="print_panel_content">
				<table class="print_content_formTable" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td class="fr" style="width: 25%">单 位</td>
					...
					<tr>
						<td class="fr" style="width: 25%">姓 名</td>
						<td class="fl">
							<div style="margin-left: 8px;width: 25%;">
								${secrecyPerson.userInfo.name}
							</div>
						</td>
						<td class="fr" style="width: 25%">性 别</td>
						<td class="fl" style="width: 20%">
							<div style="margin-left: 8px">
					...
					<tr>
						<td class="fr" style="width: 25%">签订保密责任书时间</td>
						<td class="fl">
							<div style="margin-left: 8px">
					...
					<tr>
						<td class="fr" style="width: 25%">取得上岗证书时间</td>
						<td class="fl">
							<div style="margin-left: 8px">
					...
					<tr>
						<td class="fr" style="width: 25%">单位审查意见</td>
