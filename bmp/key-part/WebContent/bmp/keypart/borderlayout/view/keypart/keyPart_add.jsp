			...
			<div class="panel tMargin">
				<div class="panel_header">
					<div class="panel_title panel_titleListIco">
						<s:if test="#request.part.department!=null">保密要害部门【${part.department.departmentName}】 ─ 新增保密要害部位</s:if>
						<s:else>新增保密要害部位</s:else>
					</div>
					<div class="panel_btn_bar pop_button_bar"></div>
				</div>
				<div class="panel_content panel_content_table">
					<form id="form_part_add" class="form" action="<s:url action='part_adding' namespace='/bmp/part' includeParams='true'/>" enctype="multipart/form-data" method="post">
						...
						<table class="content_table st" id="table_part_add" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" name="part.partName" value="${part.partName}" class="validate['required','length[50]'] textInput" /> <font color="red">&nbsp;&nbsp;* </font>
								</td>
								<td class="tbLable fr">
									主管部门：
								</td>
								<td class="tbValue fl">
									<s:if test="#request.nestedflag==1"><!-- 内嵌页面 -->
									...
									<s:else>
										...
										required="true" onlyFromValue="false" text="${department.departmentName }"
										value="${department.departmentId }" buttonEl="btnDepartName"></dep:selectByOrgan>
									</s:else>
								</td>
							</tr>
							<tr>
								...
								<td class="tbValue fl">
									<ui:selectByOrgan valueEl="part.person.userInfoId" textEl="part.person.name" required="true" onlyFromValue="false"
									buttonEl="btnPerson"></ui:selectByOrgan>
								</td>
								<td class="tbLable fr">
									联系电话：
								</td>
							...
							<tr>
								...
								<td class="fl" colspan="3">
									<textarea style="width:95%; height: 100px;" name="part.secScope" class="validate['length[500]']"></textarea><br/>
							...
							<tr>
								...
								<td class="fl" colspan="3">
									<input type="text" name="part.skillMeasure" value="${part.skillMeasure}" class="textInput validate['length[100]']" style="width: 90%" />
								</td>
							</tr>
						</table>
					...
					<table class="content_table st" id="table_part_add" width="100%">
						...
						<tr>
							<td class="fl" colspan="4">
								<b>填表提示：</b><br/>
								部位名称： 如填写“机要室”、“保密室”、“档案室”、“文印室”、“机房”、“资料室”等。<br/>
								具体位置： 填写样式如“×××楼×××层×××号”。<br/>
