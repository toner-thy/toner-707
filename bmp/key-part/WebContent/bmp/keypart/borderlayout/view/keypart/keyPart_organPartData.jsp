	...
	<body style="overflow: auto;">
		...
		<div class="panel_content"  >
			...
			<cp:search show="false" divId="cp002">
				<form action="<s:url action="part_organPartData" namespace="/bmp/part"/>" method="post" id="queryform">
				...
				<div class="panel_content panel_content_table">
					<s:if test="#request.partList.size>0">
						<ec:table items="partList" var="part" tableId="partList" border="0"
							action="${ctx}/bmp/part/part_organPartData.action"
