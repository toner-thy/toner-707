...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function change_secrecyLimitType() {
				...
				//secrecyCountryItem.secrecyLimitEndDate
		...
		<div class="body_content">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form action="${ctx}/bmp/secrecycountryitem/secrecyCountryItem_adding.action" method="post" id="add_form" name="add_form">
						<table align="center" class="content_table st" width="100%">
							<tr>
								<td class="tbLable fr">商业秘密事项名称：</td>
								<td class="tbValue fl" colspan="3" style="width:100%">
									<input id="secrecyCountryItem.secrecyCountryItemName" name="secrecyCountryItem.secrecyCountryItemName" type="text"
									class="validate['required','length[300]']"  style="width:75%"/>
							...
							<tr>
								...
								<td class="tbValue fl">
									...
									class="validate['length[20]','digit']"  style="width:130px;"/>
								</td>
                         ...
                         <%--    <tr id="secrecyLimitBeginDate_red">
								...
								<td class="tbValue fl" colspan="3">
									<input type="text" name="secrecyCountryItem.secrecyLimitBeginDate" style="width:137px;"
									value=""
							...
							<tr id="secrecyLimitEndDate_red">
								...
								<td class="tbValue fl" colspan="3">
									<input type="text" name="secrecyCountryItem.secrecyLimitEndDate" style="width:137px;"
									value=""
							...
							<tr>
								...
								<td class="tbValue fl" colspan="3">
									<sp:selectSecrecyPerson required="true" onlyFromValue="false" styleClass="validate['length[32]']" buttonEl="secrecyPersonName"
									 valueEl="secrecyCountryItem.formulateSecrecyPerson.userInfoId"
									 textEl="secrecyCountryItem.formulateSecrecyPerson.name"  ></sp:selectSecrecyPerson>
								</td>
							</tr>
 ...
 --%>
						   <tr id="removeSecrecyCondition_red" >
								...
								<td class="tbValue fl" colspan="3">
									<input id="secrecyCountryItem.removeSecrecyCondition" name="secrecyCountryItem.removeSecrecyCondition"
									 type="text" class="validate['length[400]']"  style="width:75%;" />
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="tbValue fl" colspan="3"><!-- IE居然要用 onclick事件，才能触发js   firefox使用onchange就可以使用js-->
							...
							<tr>
								...
								<td align="left" colspan="3">
									<textarea  class="validate['length[2000]']" id="secrecyCountryItem.content" name="secrecyCountryItem.content" style="width:75%;height:150px;"></textarea>
								</td>
							</tr>
						</table>
						...
						<div align="center">
							...
							<input type="hidden" id="secrecyCountryItem.secrecyStatus" name="secrecyCountryItem.secrecyStatus" value="0" />
						</div>

					</form>
					<form action="${ctx}/bmp/secrecycountryitem/secrecyCountryItem_add.action" method="post" id="init_form" name="init_form">
					</form>
				</div>
			</div>
			<!-- 内容panel结束-->
