...
<html>
		...
		<script type="text/javascript">
			...
			function doDel(action){
				...
				var jsonRequest = new Request.JSON({
 					url: '${ctx}/bmp/secrecycountryitem/ajax_relationship_secrecyCountryItem.action?secrecyCountryItemId='+ids,
 				    onComplete: function(result, text){
 				    	if (result.flag != null && result.flag != "0") {
 				    		...
 				    		if(window.confirm("确定要删除吗？")){
 								document.getElementById("secrecyCountryItemIds").value = ids;
 								document.getElementById("secrecyCountryItemDelForm").action = action;
 								document.getElementById("secrecyCountryItemDelForm").submit();
 							}
 				    	}
 				    }
 				}).get({
 					'secrecyCountryItemId' : ids
 				});
			}
	...
	<body>
		...
		<form action="" name="secrecyCountryItemDelForm" method="post" id="secrecyCountryItemDelForm">
