...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//导出
			function doExport_secrecycountryitemLayer(){
				var frm = $('excel_secrecycountryitemLayer_form');
				frm.action = "${ctx}/bmp/secrecycountryitem/export_CountrySecrecy_Layer.action";
				frm.submit();
			}

			//回调方法
			function callBackFunction_count_CountrySecrecy_Layer(beginDate, endDate, dateType){
				var url = "${ctx}/bmp/secrecycountryitem/count_CountrySecrecy_Layer.action?&districtCode=${param.districtCode}&dateType="+dateType;
				if(beginDate!="") {
					url += "&beginDate="+beginDate+"&endDate="+endDate;
				}
				$('count_CountrySecrecy_Layer').getParent().load(url);
			}
	...
	<body>
		...
		<div style="padding:5px;" id="count_CountrySecrecy_Layer">
			<!-- 年度过滤器 -->
			<yearStat:yearstat_query actionUrl="${ctx}/bmp/secrecycountryitem/count_CountrySecrecy_Layer.action"
			callBackFunction="callBackFunction_count_CountrySecrecy_Layer" yearStatProvider="${yearStatProvider }"></yearStat:yearstat_query>
			...
			<div class="panel tMargin" style="overflow-y: auto;">
				<div class="panel_header">
					...
					<div class="panel_btn_bar pop_button_bar">
						<a href="###" id="doExport"  onclick="doExport_secrecycountryitemLayer()" class="pop_button"><span>导出</span></a>
					</div>
				</div>
			...
			<form action="" name="excel_secrecycountryitemLayer_form" id="excel_secrecycountryitemLayer_form" enctype="application/x-www-form-urlencoded">
