...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//导出
			function doExport_secrecycountryitemClearDistrict(){
				var frm = $('excel_secrecycountryitemClearDistrict_form');
				frm.action = "${ctx}/bmp/secrecycountryitem/export_ClearCountrySecrecy_District.action";
				frm.submit();
			}

			//回调方法
			function callBackFunction_count_ClearCountrySecrecy_District(beginDate, endDate, dateType){
				var url = "${ctx}/bmp/secrecycountryitem/count_ClearCountrySecrecy_District.action?&districtCode=${param.districtCode}&dateType="+dateType;
				if(beginDate!="") {
					url += "&beginDate="+beginDate+"&endDate="+endDate;
				}
				$('count_ClearCountrySecrecy_District').getParent().load(url);
			}
	...
	<body>
		...
		<div style="padding:5px;" id="count_ClearCountrySecrecy_District">
			<!-- 年度过滤器 -->
			<yearStat:yearstat_query actionUrl="${ctx}/bmp/secrecycountryitem/count_ClearCountrySecrecy_District.action"
			callBackFunction="callBackFunction_count_ClearCountrySecrecy_District" yearStatProvider="${yearStatProvider }"></yearStat:yearstat_query>
			...
			<div class="panel tMargin" style="overflow-y: auto;">
				<div class="panel_header">
					...
					<div class="panel_btn_bar pop_button_bar">
						<a href="###" id="doExport"  onclick="doExport_secrecycountryitemClearDistrict()" class="pop_button"><span>导出</span></a>
					</div>
				</div>
			...
			<form action="" name="excel_secrecycountryitemClearDistrict_form" id="excel_secrecycountryitemClearDistrict_form" enctype="application/x-www-form-urlencoded">
