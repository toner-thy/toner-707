...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//导出
			function doExport1_countryitemDistrict_form(){
				var frm = $('excel_countryitemDistrict_form');
				frm.action = "${ctx}/bmp/secrecycountryitem/export_SecrecyCountryItim_District.action";
				frm.submit();
			}
	...
	<body>
		...
		<form action="" name="excel_countryitemDistrict_form" id="excel_countryitemDistrict_form" enctype="application/x-www-form-urlencoded">
		</form>
	</body>
</html>