...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//导出
			function doExport_secrecycountryitemAddLayer(){
				var frm = $('excel_secrecycountryitemAddLayer_form');
				frm.action = "${ctx}/bmp/secrecycountryitem/export_AddCountrySecrecy_Layer.action";
				frm.submit();
			}

			//回调方法
			function callBackFunction_count_AddCountrySecrecy_Layer(beginDate, endDate, dateType){
				var url = "${ctx}/bmp/secrecycountryitem/count_AddCountrySecrecy_Layer.action?&districtCode=${param.districtCode}&dateType="+dateType;
				if(beginDate!="") {
					url += "&beginDate="+beginDate+"&endDate="+endDate;
				}
				$('count_AddCountrySecrecy_Layer').getParent().load(url);
			}
	...
	<body>
		...
		<div style="padding:5px;" id="count_AddCountrySecrecy_Layer">
			<!-- 年度过滤器 -->
			<yearStat:yearstat_query actionUrl="${ctx}/bmp/secrecycountryitem/count_AddCountrySecrecy_Layer.action"
			callBackFunction="callBackFunction_count_AddCountrySecrecy_Layer" yearStatProvider="${yearStatProvider }"></yearStat:yearstat_query>
			...
			<form action="" name="excel_secrecycountryitemAddLayer_form" id="excel_secrecycountryitemAddLayer_form" enctype="application/x-www-form-urlencoded">
