	...
	<body>
		...
		<div id="body_content" class="body_content">
			...
			<div class="tree_right_content"><!-- 右边表的内容  src=初始化内容 -->
				<iframe name="contentIframe" id="contentIframe" scrolling="auto" src="${ctx}/bmp/secrecycountryitem/secrecyCountryItem_query_list.action?&ywFlag=1&isChildren=1" height="100%" width="100%" frameborder="0"></iframe>
			</div>
		</div>
	</body>
</html>
...
<script type="text/javascript">
	...
	function doChangeValue(){
		...
		var url = "${ctx}/bmp/secrecycountryitem/secrecyCountryItem_query_list.action?&ywFlag=1&districtCode="+districtCode+"&isChildren="+isChildren;
	...
	tree.addEvent('select',function(node){
		...
		contentLoad("${ctx}/bmp/secrecycountryitem/secrecyCountryItem_query_list.action?&ywFlag=1&districtCode="+node.data.id+"&isChildren="+isChildren+"&$(&editable=0&_ts"+$time());
	});
	// 最后的10是上下边距和
