								...
								<table style="width: 100%;" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td class="td_content_right">
											<c:if test="${cmap.a3!=0}">
												<a href="###" onclick="doSecrecyCountryItemViewBendanWei('${organ.organId}','3')">
													${cmap.a3}
												</a>
											</c:if>
									...
									<tr>
										...
										<td class="td_content_right">
											<c:if test="${cmap.a2!=0}">
												<a href="###" onclick="doSecrecyCountryItemViewBendanWei('${organ.organId}','2')">
													${cmap.a2}
												</a>
											</c:if>
									...
									<tr>
										...
										<td class="td_content_right">
											<c:if test="${cmap.a1!=0}">
												<a href="###" onclick="doSecrecyCountryItemViewBendanWei('${organ.organId}','1')">
													${cmap.a1}
												</a>
											</c:if>
