		...
		<div class="body_content">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form action="${ctx}/bmp/secrecyProducts/secrecyProducts_editing.action" method="post" id="add_form" name="add_form">
						<table align="center" class="content_table st" width="100%">
							<tr>
								...
								<td class="tbValue fl" colspan="3">
									...
									style="width: 75%"
									class="validate['required','length[50]']" value="${secrecyProducts.secrecyproductsName }" />
									<input type="hidden" id="secrecyProducts.secrecyproductsId" name="secrecyProducts.secrecyproductsId" value="${secrecyProducts.secrecyproductsId }" />
							...
							<tr>
								...
								<td class="tbValue fl"  colspan="3">
									<ui:selectByOrgan valueEl="secrecyProducts.formulatesecrecyPerson.userInfoId" textEl="secrecyProducts.formulatesecrecyPerson.name"
									 text="${secrecyProducts.formulatesecrecyPerson.name}" value="${secrecyProducts.formulatesecrecyPerson.userInfoId}"
									 required="true" onlyFromValue="false" styleClass="validate['length[32]']"/>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="tbValue fl" >
									<dep:selectByOrgan valueEl="secrecyProducts.departId.departmentId" textEl="departmentName"
									 onlyFromValue="false" text="${secrecyProducts.departId.departmentName}" required="false"
							...
							<tr>
								...
								<td class="tbValue fl">
									...
									class="validate['length[20]','digit']" value="${secrecyProducts.secrecyLimit }" style="width:130px;"/>
								</td>
							...
							<tr >
								...
								<td class="tbValue fl" >
									<input type="text" name="secrecyProducts.secrecyLimitBegindate"
									...
									onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly" style="width:130px;"/>
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							...
							<tr>
								...
								<td align="left" colspan="3">
									<textarea class="validate['length[2000]']" id="secrecyProducts.content" name="secrecyProducts.content" style="width:75%;height:150px;">${secrecyProducts.content }</textarea>
								</td>
							</tr>
						</table>
						...
						<div align="center">
							...
							<input type="hidden" id="secrecyProducts.secrecyStatus" name="secrecyProducts.secrecyStatus" value="${secrecyProducts.secrecyStatus}" />

							<input type="hidden" id="secrecyProducts.createPerson.userId" name="secrecyProducts.createPerson.userId" value="${secrecyProducts.createPerson.userId}" />
							<input type="hidden" id="secrecyProducts.createTime" name="secrecyProducts.createTime" value="${secrecyProducts.createTime}" />
							<input type="hidden" id="secrecyProducts.createOrgan.organId" name="secrecyProducts.createOrgan.organId" value="${secrecyProducts.createOrgan.organId}" />
						</div>
