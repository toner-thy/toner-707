...
<html>
	<head>
		...
		<script type="text/javascript">
 			...
 			function doSecrecyProductsViewBenDanWei(id,secrecyLevel){
 				var titleText = "密品撰取-列表";
 				if(secrecyLevel=="-1") {
 					titleText = "密品合计-列表";
 				}
 				TabUtil.openAsTab({
 					url : '${ctx}/bmp/secrecyProducts/indexView_DetailList.action?organId='+id+'&secrecyLevel='+secrecyLevel+'&t_date='+ new Date().getTime(),
 					title : titleText
 				});
 			}
			...
			// 点击搜索框，提示消失
			function clrSecrecyProductsInput(){
			...
			<!--
				...
				<tr>
					...
					<td align="left" style="float: left; padding-bottom: 8px; border-bottom: 1px dotted #99CCE8;">
						<input type="text" id="part.partName" value="请输入部位名称" onclick="clrSecrecyProductsInput();" style="color: #C6C6C6; height: 18px; width: 110px; border-bottom: 1px solid #7F9DB9; border-top: 1px solid #7F9DB9; border-left: 1px solid #7F9DB9; border-right: 0px; float: left; line-height: 19px; padding-left: 3px;"/><div onclick="doSecrecyProductsView2();" title="点击快速搜索密品" style="background: url('${ctx}/images/index/search/indexPanelSearchBtn.gif') 0px 0px no-repeat; height:20px;width: 24px;float: left; cursor: hand;"></div>
					</td>
					<td style="width: 5px;"></td>
				</tr>
			-->
					...
					<table style="width: 100%;">
						<tr>
							<td align="right" width="90" valign="top">
								<!-- 图标 -->
								<img src="${ctx}/bmp/images/index/keySecrecyProducts/ico.jpg">
							</td>
							<td align="left" width="*">
								<!-- 统计内容 -->
								<table style="width: 100%;" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td class="td_content_right">
											<c:if test="${cmap.a3!=0}">
												<a href="###" onclick="doSecrecyProductsViewBenDanWei('${organ.organId}','3')">
													${cmap.a3}
												</a>
											</c:if>
									...
									<tr>
										...
										<td class="td_content_right">
											<c:if test="${cmap.a2!=0}">
												<a href="###" onclick="doSecrecyProductsViewBenDanWei('${organ.organId}','2')">
													${cmap.a2}
												</a>
											</c:if>
									...
									<tr>
										...
										<td class="td_content_right">
											<c:if test="${cmap.a1!=0}">
												<a href="###" onclick="doSecrecyProductsViewBenDanWei('${organ.organId}','1')">
													${cmap.a1}
												</a>
											</c:if>
