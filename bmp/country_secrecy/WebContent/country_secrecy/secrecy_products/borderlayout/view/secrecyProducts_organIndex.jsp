...
<table class="contentTable" width="900" border="1" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="6" align="center">密品</td>
        </tr>
        <tr>
       ...
       <c:forEach items="${secrecyProductsList}" var="secrecyProducts" varStatus="xm">
		<tr class="${xm.count % 2 == 0 ? 'odd' : 'even'}" onmouseover="this.className='highlight'" onmouseout="this.className='${xm.count % 2 == 0 ? 'odd' : 'even' }'">
			...
			<td width="200px;">
				<fmt:formatDate value='${secrecyProducts.secrecyLimitBegindate}' pattern='yyyy-MM-dd'/> 至 <fmt:formatDate value='${secrecyProducts.secrecyLimitEnddate}' pattern='yyyy-MM-dd'/>
			</td>
			<td >
