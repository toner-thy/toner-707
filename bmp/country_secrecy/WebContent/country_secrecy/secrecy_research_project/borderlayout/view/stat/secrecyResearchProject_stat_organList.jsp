	...
	<head>
		...
		<script type="text/javascript">
			...
			function doView(id,secrecyLevel){
				...
				url : '${ctx}/bmp/secrecyResearchProject/zhtj_DetailList.action?organId='+id+'&secrecyLevel='+secrecyLevel+'&district.districtCode='+${district.districtCode}+'&t_date=' + new Date().getTime(),
				width : 800,
				height : 550,
	...
	<body>
		<div class="button_bar">
			<div class="left">
			    ...
			    <a class="pop_button" href="${pageContext.request.contextPath}/bmp/secrecyResearchProject/zhtj_query_Detail.action?district.districtCode=${district.districtCode}"><span>返回</span></a>
			</div>
			<div class="right">
		...
		<div id="body_content" class="body_content">
			<div>
				<bmp:navigationBar district="${district}" topDistrict="${topDistrict}"  url="${pageContext.request.contextPath}/bmp/secrecyResearchProject/zhtj_queryByDistrict.action"/>
			</div>
    		...
    		<div class="panel">
				...
				<div class="panel_content">
					<!-- 查询内容开始 -->
					<form action="zhtj_queryByDistrict.action" method="post" id="secrecyResearchProjectStat_organList_form" name="secrecyResearchProjectStat_organList_form">
				            ...
				            <tr>
								...
								<td>
									<div class="btn_query_bar pop_button_bar">
										<a class="pop_button" href="javascript:document.getElementById('secrecyResearchProjectStat_organList_form').submit();"><span>查 询</span></a>
									</div>
								</td>
							</tr>
						</table>
			...
			<div class="panel tMargin">
				<div class="panel_header">
					<div class="panel_title panel_titleListIco">
						【${district.districtName }】行政区划涉密科研项目统计
					</div>
