		...
		<div class="body_content">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form action="${ctx}/bmp/secrecyResearchProject/secrecyResearchProject_editing.action" method="post" id="add_form" name="add_form">
						<table align="center" class="content_table st" width="100%">
							<tr>
								...
								<td class="tbValue fl" colspan="3">
									...
									class="validate['required','length[50]']" value="${secrecyResearchProject.secrecyResearchProjectName }"
									 style="width: 75%" />
 									<input type="hidden" id="secrecyResearchProject.secrecyResearchProjectId" name="secrecyResearchProject.secrecyResearchProjectId" value="${secrecyResearchProject.secrecyResearchProjectId }" />
							...
							<tr>
								...
								<td class="tbValue fl"  colspan="3">
									<sp:selectSecrecyPerson required="true" onlyFromValue="false" styleClass="validate['length[50]']" buttonEl="secrecyPersonName"
									 valueEl="secrecyResearchProject.formulateSecrecyPerson.userInfoId" value="${secrecyResearchProject.formulateSecrecyPerson.userInfoId }"
									 textEl="secrecyResearchProject.formulateSecrecyPerson.name" text="${secrecyResearchProject.formulateSecrecyPerson.name }" />
								</td>
							</tr>
							...
							<tr>
								...
								<td class="tbValue fl">
									<input id="secrecyResearchProject.secrecyLimit" name="secrecyResearchProject.secrecyLimit" type="text" style="width:130px;"
									class="validate['length[20]','digit']" value="${secrecyResearchProject.secrecyLimit }"/>
								</td>
							...
							<tr>
								...
								<td align="left" colspan="3">
									<textarea class="validate['length[2000]']" id="secrecyResearchProject.content" name="secrecyResearchProject.content" style="width:75%;height:150px;">${secrecyResearchProject.content }</textarea>
								</td>
							</tr>
						</table>
						...
						<div align="center">
							...
							<input type="hidden" id="secrecyResearchProject.secrecyStatus" name="secrecyResearchProject.secrecyStatus" value="${secrecyResearchProject.secrecyStatus }" />

							<input type="hidden" id="secrecyResearchProject.createPerson.userId" name="secrecyResearchProject.createPerson.userId" value="${secrecyResearchProject.createPerson.userId}" />
							<input type="hidden" id="secrecyResearchProject.createTime" name="secrecyResearchProject.createTime" value="${secrecyResearchProject.createTime}" />
							<input type="hidden" id="secrecyResearchProject.createOrgan.organId" name="secrecyResearchProject.createOrgan.organId" value="${secrecyResearchProject.createOrgan.organId}" />
						</div>
