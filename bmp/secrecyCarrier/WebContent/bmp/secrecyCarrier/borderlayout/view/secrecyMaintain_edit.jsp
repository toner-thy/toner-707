	 ...
	 <!-- 公共头部 -->
		...
		<!-- 内容panel开始 -->
	 		<div class="panel">
				...
				<form id="add_form" class="form"  action="<s:url namespace='/bmp/secrecyMaintain' action='secrecyMaintain_update' includeParams='true'/>" method="post" enctype="multipart/form-data">
