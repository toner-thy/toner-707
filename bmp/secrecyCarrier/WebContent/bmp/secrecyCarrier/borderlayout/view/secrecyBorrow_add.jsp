		...
		<script type="text/javascript">
			...
			$ENV.loader.loadJavaScript("${ctx}/resources/js/formcheck/1.4/formcheck.js",function(){
				$ENV.onDomReady(function(){
					...
					formcheck = new FormCheck('form_secrecyBorrow_save',{
								display:{
	 ...
	 <!-- 公共头部 -->
		...
		<!-- 内容panel开始 -->
	 		<div class="panel">
				...
				<form id="form_secrecyBorrow_save" class="form"  action="<s:url namespace='/bmp/secrecyBorrow' action='secrecyBorrow_save' includeParams='true'/>" method="post" enctype="multipart/form-data">
					<table class="content_table">
						<tr>
								...
								<td class="tbValue fl">
								    <input class="Wdate validate['required']" readonly="readonly" onfocus="WdatePicker()" value="${secrecyBorrow.date}" name="secrecyBorrow.date">
							...
							<tr>
								...
								<td class="tbValue fl">
								 <input class="Wdate validate['required']" readonly="readonly" onfocus="WdatePicker()" value="${secrecyBorrow.returnDate}" name="secrecyBorrow.returnDate">
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
					</table>
