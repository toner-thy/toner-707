	 ...
	 <!-- 公共头部 -->
		...
		<!-- 内容panel开始 -->
	 		<div class="panel">
				...
				<form id="add_form" class="form"  action="<s:url namespace='/bmp/secrecyBorrow' action='secrecyBorrow_save' includeParams='true'/>" method="post" enctype="multipart/form-data">
