	 ...
	 <!-- 公共头部 -->
		...
		<!-- 内容panel开始 -->
	 		<div class="panel">
				...
				<form id="add_form" class="form"  action="<s:url namespace='/bmp/secrecyPrint' action='secrecyPrint_update' includeParams='true'/>" method="post" enctype="multipart/form-data">
