		...
		<script type="text/javascript">
			...
			$ENV.loader.loadJavaScript("${ctx}/resources/js/formcheck/1.4/formcheck.js",function(){
				$ENV.onDomReady(function(){
					...
					formcheck = new FormCheck('form_secrecyPrint_update',{
								display:{
	 ...
	 <!-- 公共头部 -->
		...
		<!-- 内容panel开始 -->
	 		<div class="panel">
				...
				<form id="form_secrecyPrint_update" class="form"  action="<s:url namespace='/bmp/secrecyPrint' action='secrecyPrint_update' includeParams='true'/>" method="post" enctype="multipart/form-data">
					<table class="content_table">
							<tr>
								...
								<td class="tbValue fl">
								    <input class="Wdate validate['required']" readonly="readonly" onfocus="WdatePicker()" value="<s:date name="secrecyPrint.date" format="yyyy-MM-dd"/>" name="secrecyPrint.date">
							...
							<tr>
								...
								<td class="tbValue fl">
									...
									value="${undertaker}" textProperty="name" valueProperty="userInfoId"
							...
							<tr>
								...
								<ui:multySelect  dialogWidth="0.9" dialogHeight="0.8"  valueEl="secrecyPrint.approver" textEl="receivePersonNames3"
									value="${approver}" textProperty="name" valueProperty="userInfoId"
									onlyFromValue="true" required="true"  buttonEl="readPerson2"/>
								</td>
							</tr>
					</table>
						<input type="hidden" id="secrecyPrint.id" name='secrecyPrint.id' value="${secrecyPrint.id}" class="btn_23" style="display: none;"/>
