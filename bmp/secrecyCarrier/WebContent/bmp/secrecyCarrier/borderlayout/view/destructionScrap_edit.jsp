		...
		<script type="text/javascript">
			...
			$ENV.loader.loadJavaScript("${ctx}/resources/js/formcheck/1.4/formcheck.js",function(){
				$ENV.onDomReady(function(){
					...
					formcheck = new FormCheck('form_destructionScrap_update',{
								display:{
	 ...
	 <!-- 公共头部 -->
		...
		<!-- 内容panel开始 -->
	 		<div class="panel">
				...
				<form id="form_destructionScrap_update" class="form"  action="<s:url namespace='/bmp/destructionScrap' action='destructionScrap_update' includeParams='true'/>" method="post" enctype="multipart/form-data">
