		...
		<div id="body_content" class="body_content">
			...
			<cp:start defaultTitle="涉密设备维修情况简介" ctx="${ctx}" icoPath="">
				...
				<cp:search show="true" divId="cp002">
					<s:form action="secrecyMaintain_allList" id="secrecyMaintain_list_form" theme="simple">
			...
			<div class="panel tMargin">
				<div class="panel_header">
					<div class="panel_title panel_titleListIco">
						...
						${district.districtName} - 涉密设备维修情况列表

					</c:if>
					<c:if test="${showType eq '1'}">
						${district.districtName}<dis:levelText district="${district}"></dis:levelText>级机关单位 - 涉密设备维修情况列表
					</c:if>
					</div>
				...
				<div class="panel_content">
					<s:if test="#request.list.size>0">
						<ec:table items="list" var="secrecyMaintain" tableId="list" border="0"
								action="${ctx}/bmp/secrecyMaintain/secrecyMaintain_allList.action"
