...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//导出
			function doExport(){
				window.location.href = "${ctx}/bmp/secrecyworksummary/secrecyWorksummary_exportDataDetail.action?district.districtCode=${district.districtCode}&flag=keyPart" +
