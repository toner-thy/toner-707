...
/* 				background: url('${pageContext.request.contextPath}/bmp/borderlayout/skin/blue/img/login/content_back.gif') 0px 0px repeat-x; */
	...
	<body>
<!-- -----------------------------== 装载AIP控件 ==--------------------------------- -->
<OBJECT id="HWPostil1" align="middle" style="display: none"
	classid="clsid:FF1FE7A0-0578-4FEE-A34E-FB21B277D561" codebase="${pageContext.request.contextPath}/bmp/borderlayout/skin/blue/img/login/HWPostil.cab#version=3,1,1,8">
</OBJECT>
<!-- --------------------------------== 结束装载控件 ==----------------------------------- -->
		<form action="${pageContext.request.contextPath }/platform/login/logining.action" method="post">
			...
			<div style="width:1024px; padding: 10px;">
				<div id="content" align="center" style="position:relative; width:auto;margin-top: 100px;">
