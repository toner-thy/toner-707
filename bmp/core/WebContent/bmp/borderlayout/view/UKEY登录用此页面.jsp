...
<%-- --%> 		<script language="VBScript"> 
			...
			if(result = 0) then
				document.loginForm.idFromToken.value = IDfromToken
			end if
			end sub
			 -->
<%-- --%>		</script> 
...
<!-- 	UK登陆注释开始，注意选择ukey登录方式-->
	<body onload="Procedure2()">
		...
		<form name="loginForm" action="${pageContext.request.contextPath }/ukeymanage/ukeyInfo/ukeyInfo_login.do" method="post">
			...
			<div id="header">
				<div class="headerLeft">
					<%
						session.setAttribute("loginType", "scbmp");
					%>
 					<!-- 头部左侧图片 -->
					<img src="${pageContext.request.contextPath}/bmp/borderlayout/skin/blue/img/login/header_left_scbmp.gif"/>
				</div>
			...
			<div style="width:1024px; padding: 10px;">
				<table>
					<tr>
						<td>
							<iframe name="myNotice" frameborder="0" src="${ctx}/bmp/notice/notice_indexList.action" style="width:448px;height:257px;overflow:hidden; min-height: 200px;max-height:400px;"></iframe>
						</td>
						<td>&nbsp;</td>
						<td>
					...
					<tr>
						<td>
							<iframe name="myAtta" frameborder="0" src="${ctx}/bmp/attachment/attachment_indexList.action" style="overflow-y:hidden;width:448px;height:227px;"></iframe>
						</td>
						<td>&nbsp;</td>
						<td>
							<iframe name="myHelp" frameborder="0" src="${ctx}/platform/help/help_clientInfo.action?help.helpId=login_index_remark" style="_margin-top:-200px;width:448px;height:227px; background-color:#D1E5EC;overflow: auto;"></iframe>
						</td>
					</tr>
				</table>
			</div>
