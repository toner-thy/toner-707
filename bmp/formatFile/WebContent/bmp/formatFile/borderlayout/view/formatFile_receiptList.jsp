...
<html>
		...
		<script language="javascript">
			...
			function doViewStatus(){
			 	environment.dialog.open({
					url : '/bip/bmp/formatFile/borderlayout/view/formatFile_receiptDetail.jsp?t_date=' + new Date().getTime(),
	...
	<body>
		...
		<div class="button_bar">
			<div class="left">
				<div class="pop_button_bar"><a href="###"  onclick="doAdd('');this.blur();" class="pop_button"><span>签收</span></a></div>
			</div>
			<div class="right">
...
<table id="formatFileList_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="100%" >
	...
	<tr class="odd"  onmouseover="this.className='highlight'"  onmouseout="this.className='odd'" >
		...
		<td width="15%" ><font color="red">未签收</font></td>
		<td width="40%" >
