...
<script type="text/javascript">
	...
	function doDetail() {
		$ENV.dialog.open({
					url : "${ctx}/bmp/workbench-demo/departmentNetwork/departmentNetwork_detail.jsp?_ts=" + new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '详情'
				});
	...
	<div class="button_bar">
		<div class="left">
			<div class="pop_button_bar">
				<div class="pop_button_bar">
					<a href="###" onclick="doAdd('${ctx}/bmp/workbench-demo/departmentNetwork/departmentNetwork_add.jsp');this.blur();" class="pop_button"><span>新增</span></a>
					<a href="###" onclick="doEdit('${ctx}/bmp/workbench-demo/departmentNetwork/departmentNetwork_edit.jsp');this.blur();" class="pop_button"><span>编辑</span></a>
	...
	<div class="body_content">
		...
		<div class="panel">
			<div id="cpPanel" style="width: 100%;">
				<!-- 切换按钮 -->
				<div class="cpBtnBar">
					<div id="cp001Btn" class="cpBtn_ov" href="###" onmouseover="javascript:showCp(2,'cp001','机关网站建设、运行保密管理情况简介');">关 于</div>
					<div id="cp002Btn" class="cpBtn" href="###" onmouseover="javascript:showCp(2,'cp002','机关网站建设、运行保密管理情况查询');">查 询</div>
				</div>
				<!-- 切换面板 -->
						...
						<tr>
							...
							<td width="*" valign="top">
								<div id="cp001"
									...
									<!-- 模块简介 -->
									<div class="cpMsgTitle">关于机关网站建设、运行保密管理情况</div>
									<div class="cpMsgContext">
										机关网站建设、运行保密管理情况 机关网站建设、运行保密管理情况
									</div>
									<!-- 上下之间的间隔，可以调节高度 -->
		...
		<div class="panel tMargin">
			<div class="panel_header">
				<div class="panel_title panel_titleListIco">机关网站建设、运行保密管理情况列表</div>
						...
						<table id="keySectionlist_table" border="0" cellspacing="0"
							...
							<thead>
								<tr>
									...
									<td class="tableHeader" width="10%">网站名称</td>
									<td class="tableHeader" width="10%">管理员姓名</td>
									<td class="tableHeader" width="10%">管理员职务</td>
									<td class="tableHeader" width="10%">上网信息审批人</td>
