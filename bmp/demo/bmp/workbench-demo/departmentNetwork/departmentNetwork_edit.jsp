					...
					<form id="add_form" action="<s:url namespace='/secrecyorganization/secrecyoffice' action='secrecyOffice_adding' includeParams='true'/>" method="post">
						<table class="content_table" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl">
									<%
										...
										ui2.setUserInfoId("xxx");
										ui2.setName("孔丘");
										uiList.add(ui2);
										request.setAttribute("uiList", uiList);
									%>
									<ui:multySelectByOrgan textEl="name" valueEl="userInfoId" value="${uiList }" textProperty="name" valueProperty="userInfoId" buttonEl="uiSelectorx"></ui:multySelectByOrgan>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
							...
							<tr>
								...
								<td class="tbValue fl">
									<ui:multySelect textEl="name1" valueEl="userInfoId1" value="${uiList }" textProperty="name" valueProperty="userInfoId" buttonEl="uiSelector1"></ui:multySelect>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									<input type="text" readonly="readonly" class="Wdate" value="2014" onFocus="WdatePicker({dateFmt:'yyyy'})" /> <font color="red">*</font>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
