...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function doSave(){
				window.location.href = "${ctx}/bmp/workbench-demo/annualWorkPlan/annualWorkPlan_list.jsp";
			}
		</script>
	</head>
					...
					<form id="add_form" action="<s:url namespace='/secrecyorganization/secrecyoffice' action='secrecyOffice_adding' includeParams='true'/>" method="post">
						<table class="content_table" width="100%">
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" size="50" value="XX保密委员会2014年年度工作计划"/><span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									<input type="text" readonly="readonly" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy'})" value="2014" />
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								<td colspan="2" >
								<textarea rows="50" cols="70" name="content">年度工作计划年度工作计划年度工作计划年度工作计划年度工作计划年度工作计划</textarea>
								</td>
							</tr>
						</table>
