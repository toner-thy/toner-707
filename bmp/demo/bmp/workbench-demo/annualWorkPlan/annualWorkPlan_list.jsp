...
<script type="text/javascript">
	...
	function doDetail() {
		$ENV.dialog.open({
					url : "${ctx}/bmp/workbench-demo/annualWorkPlan/annualWorkPlan_detail.jsp?_ts=" + new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '详情'
				});
	...
	<div class="button_bar">
		<div class="left">
			<div class="pop_button_bar">
				<div class="pop_button_bar">
					<a href="###" onclick="doAdd('${ctx}/bmp/workbench-demo/annualWorkPlan/annualWorkPlan_add.jsp');this.blur();" class="pop_button"><span>新增</span></a>
					<a href="###" onclick="doEdit('${ctx}/bmp/workbench-demo/annualWorkPlan/annualWorkPlan_edit.jsp');this.blur();" class="pop_button"><span>编辑</span></a>
							...
							<td width="*" valign="top">
								<div id="cp001"
									...
									<div class="cpMsgContext">
										保密委员会（保密工作领导小组）年度工作计划 保密委员会（保密工作领导小组）年度工作计划
<%-- 										<a href="${ctx }/bmp/demo/demo_exportWord.action">导出测试</a> --%>
									</div>
									<!-- 上下之间的间隔，可以调节高度 -->
