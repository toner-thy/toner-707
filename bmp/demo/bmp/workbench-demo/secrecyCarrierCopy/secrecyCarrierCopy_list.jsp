...
<html>
<head>
<title>保密委员会（保密工作领导小组）参加保密会议、活动（含协作组活动）情况</title>
...
<script type="text/javascript">
	...
	function doDetail() {
		$ENV.dialog.open({
					url : "${ctx}/bmp/workbench-demo/secrecyCarrierCopy/secrecyCarrierCopy_detail.jsp?_ts=" + new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '详情'
				});
	...
	<div class="button_bar">
		<div class="left">
			<div class="pop_button_bar">
				<div class="pop_button_bar">
					<a href="###" onclick="doAdd('${ctx}/bmp/workbench-demo/secrecyCarrierCopy/secrecyCarrierCopy_add.jsp');this.blur();" class="pop_button"><span>新增</span></a>
					<a href="###" onclick="doEdit('${ctx}/bmp/workbench-demo/secrecyCarrierCopy/secrecyCarrierCopy_edit.jsp');this.blur();" class="pop_button"><span>编辑</span></a>
	...
	<div class="body_content">
		...
		<div class="panel">
			<div id="cpPanel" style="width: 100%;">
				<!-- 切换按钮 -->
				<div class="cpBtnBar">
					<div id="cp001Btn" class="cpBtn_ov" href="###" onmouseover="javascript:showCp(2,'cp001','涉密载体复印情况 简介');">关 于</div>
					<div id="cp002Btn" class="cpBtn" href="###" onmouseover="javascript:showCp(2,'cp002','涉密载体复印情况 查询');">查 询</div>
				</div>
				<!-- 切换面板 -->
						...
						<tr>
							...
							<td width="*" valign="top">
								<div id="cp001"
									...
									<!-- 模块简介 -->
									<div class="cpMsgTitle">关于涉密载体复印情况 </div>
		...
		<div class="panel tMargin">
			<div class="panel_header">
				<div class="panel_title panel_titleListIco">涉密载体复印情况列表</div>
						...
						<table id="keySectionlist_table" border="0" cellspacing="0"
							...
							<thead>
								<tr>
									...
									<td class="tableHeader" width="10%">序号</td>
									<td class="tableHeader" width="10%">文件名称</td>
									<td class="tableHeader" width="10%">承办人</td>
									<td class="tableHeader" width="10%">文件制发单位</td>
									<td class="tableHeader" width="10%">密级</td>
									<td class="tableHeader" width="10%">文号</td>
									<td class="tableHeader" width="10%">份数</td>
									<td class="tableHeader" width="10%">每份页数</td>
									<td class="tableHeader" width="10%">申请人</td>
									<td class="tableHeader" width="10%">批准人</td>
									<td class="tableHeader" width="10%">复制日期</td>
							...
							<tbody class="tableBody">
								<tr class="odd" onmouseover="this.className='highlight'"
									...
									<td width="10%">1</td>
									<td width="10%">XX议题</td>
									<td width="10%">四川省国家保密局</td>
									<td width="10%">四川省国家保密局</td>
									<td width="10%">机密</td>
									<td width="10%">皖政字〔2004 〕18号</td>
									<td width="10%">1</td>
									<td width="10%">20</td>
									<td width="10%">陆乘风</td>
									<td width="10%">曲风池</td>
