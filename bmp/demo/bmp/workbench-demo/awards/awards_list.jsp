...
<script type="text/javascript">
	...
	function doDetail() {
		$ENV.dialog.open({
					url : "${ctx}/bmp/workbench-demo/awards/awards_detail.jsp?_ts=" + new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '详情'
				});
	...
	<div class="button_bar">
		<div class="left">
			<div class="pop_button_bar">
				<div class="pop_button_bar">
					<a href="###" onclick="doAdd('${ctx}/bmp/workbench-demo/awards/awards_add.jsp');this.blur();" class="pop_button"><span>新增</span></a>
					<a href="###" onclick="doEdit('${ctx}/bmp/workbench-demo/awards/awards_edit.jsp');this.blur();" class="pop_button"><span>编辑</span></a>
	...
	<div class="body_content">
		...
		<div class="panel">
			<div id="cpPanel" style="width: 100%;">
				<!-- 切换按钮 -->
				<div class="cpBtnBar">
					<div id="cp001Btn" class="cpBtn_ov" href="###" onmouseover="javascript:showCp(2,'cp001','论文评奖情况简介');">关 于</div>
					<div id="cp002Btn" class="cpBtn" href="###" onmouseover="javascript:showCp(2,'cp002','论文评奖情况查询');">查 询</div>
				</div>
				<!-- 切换面板 -->
						...
						<tr>
							...
							<td width="*" valign="top">
								<div id="cp001"
									...
									<!-- 模块简介 -->
									<div class="cpMsgTitle">关于论文评奖情况</div>
								...
								<div id="cp002"
									...
									<form method="post" id="queryform">
										<table class="st" width="100%">
											<tr>
												<td class="tbLable fr">作者：</td>
												<td class="tbValue fl"><input type="text"/></td>
												<td class="tbLable fr">刊名：</td>
												<td class="tbValue fl"><input type="text"/></td>
<!-- 												<td class="tbValue fl"> -->
<!-- 													<input type="text" readonly="readonly" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM'})" /> <font color="red">*</font> -->
<!-- 												</td> -->
											</tr>
											<tr>
		...
		<div class="panel tMargin">
			<div class="panel_header">
				<div class="panel_title panel_titleListIco">论文评奖情况列表</div>
						...
						<table id="keySectionlist_table" border="0" cellspacing="0"
							...
							<thead>
								<tr>
									...
									<td class="tableHeader" width="10%">作者</td>
									<td class="tableHeader" width="10%">篇名</td>
									<td class="tableHeader" width="10%">刊物及期号</td>
									<td class="tableHeader" width="10%">奖项名称</td>
									<td class="tableHeader" width="10%">评奖单位</td>
							...
							<tbody class="tableBody">
								<tr class="odd" onmouseover="this.className='highlight'"
									...
									<td width="10%">凌操</td>
									<td width="10%">上市公司关联交易对财务报表的影响</td>
									<td width="10%">中国传媒科技（2014-03）</td>
									<td width="10%">优秀博士学位论文</td>
									<td width="10%">教育部、国务院学位委员会</td>
