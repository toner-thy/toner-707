						...
						<table class="content_table" width="100%">
							<tr>
								...
								<td class="tbValue fl">
									...
									text="费祎" value="${keySection.principal.userInfoId }" required="true"
							...
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" value="文学形象的新变举隅" size="50"/>
							...
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" value="南北桥" size="50"/>
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" readonly="readonly" value="2014-03" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM'})" />
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" value="第七届“黄达-蒙代尔经济学奖”" size="50"/>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									<input type="text" value="中国人民大学中国财政金融政策研究中心" size="50"/>
								</td>
							</tr>
