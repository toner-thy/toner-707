...
<html>
	...
	<body>
		...
		<div id="body_content" class="body_content">
			<!-- 复合面板开始 -->
			<cp:start defaultTitle="涉密设备维修情况简介" ctx="${ctx}" icoPath="#">
				<div id="cp001Btn" class="cpBtn_ov" href="###" onmouseover="javascript:showCp(1,'cp001','涉密设备维修情况简介');">关 于</div>
			</cp:start>
					...
					<form id="add_form" action="<s:url namespace='/secrecyorganization/secrecyoffice' action='secrecyOffice_adding' includeParams='true'/>" method="post">
						<table class="content_table" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" size="50" style="width:67%;" value="保密机柜"/><span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
								<td class="tbLable fr">
									送修时间：
								</td>
								<td class="tbValue fl">
									<input type="text" readonly="readonly" class="Wdate" value="2014-02-03 14:23:50" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
							...
							<tr>
								...
								<td class="tbValue fl" colspan="3">
								 <textarea rows="6" cols="100" style="width:98%" >保密机柜无法打开</textarea>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl" colspan="3">
								 <textarea rows="6" cols="100" style="width:98%" >同意维修</textarea>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
							...
							<tr>
								...
								<td class="tbValue fl" colspan="3">
								 <textarea rows="6" cols="100" style="width:98%" >请尽快维修，需要使用</textarea>
								</td>
							</tr>
						</table>
