					...
					<form id="add_form" action="<s:url namespace='/secrecyorganization/secrecyoffice' action='secrecyOffice_adding' includeParams='true'/>" method="post">
						<table class="content_table" width="100%">
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" size="50" value="信息发布保密审查情况"/><span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
								<td class="tbLable fr">
									信息来源：
								</td>
								<td class="tbValue fl">
									<input type="text" size="50" value="国家保密局办公室"/><span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									...
									styleClass="validate['length[32]']" value="教育部"
									 buttonEl="sss" />
								</td>
								<td class="tbLable fr">
									发布途径：
								...
								<td class="tbValue fl">
									<input type="text" size="50" value="XXXXXXXXXX"/><span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl" colspan="3">
									<textarea rows="6" cols="100">XXXXXXXXXXXX同意</textarea>
								</td>
								</tr>
								<tr>
								<td class="tbLable fr">
							...
							<tr>
								...
								<td class="tbValue fl" colspan="3">
									<textarea rows="6" cols="100">XXXXXXXXX</textarea>
								</td>
							</tr>
						</table>
