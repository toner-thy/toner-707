...
<script type="text/javascript">
	...
	function doDetail() {
		$ENV.dialog.open({
					url : "${ctx}/bmp/workbench-demo/informationConfidentiality/informationConfidentiality_detail.jsp?_ts=" + new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '详情'
				});
	...
	<div class="button_bar">
		<div class="left">
			<div class="pop_button_bar">
				<div class="pop_button_bar">
					<a href="###" onclick="doAdd('${ctx}/bmp/workbench-demo/informationConfidentiality/informationConfidentiality_add.jsp');this.blur();" class="pop_button"><span>新增</span></a>
					<a href="###" onclick="doEdit('${ctx}/bmp/workbench-demo/informationConfidentiality/informationConfidentiality_edit.jsp');this.blur();" class="pop_button"><span>编辑</span></a>
						...
						<tr>
							...
							<td width="*" valign="top">
								<div id="cp001"
									...
									<!-- 模块简介 -->
									<div class="cpMsgTitle">关于信息发布保密审查情况</div>
						...
						<table id="keySectionlist_table" border="0" cellspacing="0"
							...
							<thead>
								<tr>
									...
									<td class="tableHeader" width="10%">标题</td>
									<td class="tableHeader" width="10%">信息来源</td>
									<td class="tableHeader" width="10%">承办部门</td>
									<td class="tableHeader" width="10%">发布途径</td>
							...
							<tbody class="tableBody">
								<tr class="odd" onmouseover="this.className='highlight'"
									...
									<td width="10%">1</td>
									<td width="10%">XX密件</td>
									<td width="10%">国家保密局办公厅</td>
									<td width="10%">四川省国家保密局</td>
									<td width="10%">XXXXXX</td>
