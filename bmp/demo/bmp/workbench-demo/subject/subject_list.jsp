...
<script type="text/javascript">
	...
	function doDetail() {
		$ENV.dialog.open({
					url : "${ctx}/bmp/workbench-demo/subject/subject_detail.jsp?_ts=" + new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '详情'
				});
	...
	<div class="button_bar">
		<div class="left">
			<div class="pop_button_bar">
				<div class="pop_button_bar">
					<a href="###" onclick="doAdd('${ctx}/bmp/workbench-demo/subject/subject_add.jsp');this.blur();" class="pop_button"><span>新增</span></a>
					<a href="###" onclick="doEdit('${ctx}/bmp/workbench-demo/subject/subject_edit.jsp');this.blur();" class="pop_button"><span>编辑</span></a>
								...
								<div id="cp002"
									...
									<form method="post" id="queryform">
										<table class="st" width="100%">
											<tr>
												<td class="tbLable fr">课题（试点）名称：</td>
												<td class="tbValue fl"><input type="text"/></td>
												<td class="tbLable fr">承办人：</td>
												<td class="tbValue fl"><input type="text"/></td>
<!-- 												<td class="tbValue fl"> -->
						...
						<table id="keySectionlist_table" border="0" cellspacing="0"
							...
							<thead>
								<tr>
									...
									<td class="tableHeader" width="10%">课题（试点）名称</td>
									<td class="tableHeader" width="10%">下达单位</td>
									<td class="tableHeader" width="10%">承办人</td>
									<td class="tableHeader" width="10%">完成时间</td>
