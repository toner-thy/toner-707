...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function doSave(){
				window.location.href = "${ctx}/bmp/workbench-demo/subject/subject_list.jsp";
			}
		</script>
	</head>
					...
					<form id="add_form" action="<s:url namespace='/secrecyorganization/secrecyoffice' action='secrecyOffice_adding' includeParams='true'/>" method="post">
						<table class="content_table" width="100%">
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" value="上市公司关联交易对财务报表的影响"/>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
...
<%-- 													valueProperty="departmentId" textProperty="departmentName"/> --%>
										<dept:selectByOrgan textEl="receivePersonName_dept" text="国务院学位委员会" value="国务院学位委员会" valueEl="receivePersonAccount_dept" required="true" buttonEl="selectCopyPersonName_dept"></dept:selectByOrgan>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									...
									text="凌操" value="凌操" required="true"
							...
							<tr>
								...
								<td class="tbValue fl">
									<textarea rows="5" cols="120">具体效果描述</textarea>
								</td>
							</tr>
							<tr>
