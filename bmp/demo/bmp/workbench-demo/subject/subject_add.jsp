...
<%-- 													valueProperty="departmentId" textProperty="departmentName"/> --%>
										<dept:selectByOrgan textEl="receivePersonName_dept" valueEl="receivePersonAccount_dept" required="true" buttonEl="selectCopyPersonName_dept"></dept:selectByOrgan>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
