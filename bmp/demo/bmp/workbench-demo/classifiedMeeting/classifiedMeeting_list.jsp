...
<script type="text/javascript">
	...
	function doDetail() {
		$ENV.dialog.open({
					url : "${ctx}/bmp/workbench-demo/classifiedMeeting/classifiedMeeting_detail.jsp?_ts=" + new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '详情'
				});
	...
	<div class="button_bar">
		<div class="left">
			<div class="pop_button_bar">
				<div class="pop_button_bar">
					<a href="###" onclick="doAdd('${ctx}/bmp/workbench-demo/classifiedMeeting/classifiedMeeting_add.jsp');this.blur();" class="pop_button"><span>新增</span></a>
					<a href="###" onclick="doEdit('${ctx}/bmp/workbench-demo/classifiedMeeting/classifiedMeeting_edit.jsp');this.blur();" class="pop_button"><span>编辑</span></a>
	...
	<div class="body_content">
		...
		<div class="panel">
			<div id="cpPanel" style="width: 100%;">
				<!-- 切换按钮 -->
				<div class="cpBtnBar">
					<div id="cp001Btn" class="cpBtn_ov" href="###" onmouseover="javascript:showCp(2,'cp001','涉密会议活动情况简介');">关 于</div>
					<div id="cp002Btn" class="cpBtn" href="###" onmouseover="javascript:showCp(2,'cp002','涉密会议活动情况查询');">查 询</div>
				</div>
				<!-- 切换面板 -->
						...
						<tr>
							...
							<td width="*" valign="top">
								<div id="cp001"
									...
									<!-- 模块简介 -->
									<div class="cpMsgTitle">关于涉密会议活动情况</div>
		...
		<div class="panel tMargin">
			<div class="panel_header">
				<div class="panel_title panel_titleListIco">涉密会议活动情况列表</div>
						...
						<table id="keySectionlist_table" border="0" cellspacing="0"
							...
							<thead>
								<tr>
									...
									<td class="tableHeader" width="10%">涉密会议名称</td>
									<td class="tableHeader" width="10%">涉密等级</td>
									<td class="tableHeader" width="10%">涉密会议地点</td>
									<td class="tableHeader" width="10%">涉密会议时间</td>
							...
							<tbody class="tableBody">
								<tr class="odd" onmouseover="this.className='highlight'"
									...
									<td width="10%">XX密件</td>
									<td width="10%">机密</td>
									<td width="10%">广安市保密局办公室</td>
									<td width="10%">2014-04-05 14:00:00</td>
