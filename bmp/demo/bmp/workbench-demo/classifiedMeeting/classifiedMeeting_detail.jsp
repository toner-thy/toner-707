						...
						<table class="content_table" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl" colspan="3">
									<textarea rows="6" cols="100" readonly="readonly">广安各个保密单位必须参与和知悉</textarea>
								</td>
								</tr>
								<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl" colspan="3">
									<textarea rows="6" cols="100" readonly="readonly">各单位基本上参与，参与人员如下：XX，XX等待</textarea>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl" colspan="3">
									<textarea rows="6" cols="100" readonly="readonly">主要管理措施</textarea>
								</td>
							</tr>
						</table>
