...
<script type="text/javascript">
	...
	function doDetail() {
		$ENV.dialog.open({
					url : "${ctx}/bmp/workbench-demo/contactAndKnowStateSecrets/contactAndKnowStateSecrets_detail.jsp?_ts=" + new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '详情'
				});
	...
	<div class="button_bar">
		<div class="left">
			<div class="pop_button_bar">
				<div class="pop_button_bar">
					<a href="###" onclick="doAdd('${ctx}/bmp/workbench-demo/contactAndKnowStateSecrets/contactAndKnowStateSecrets_add.jsp');this.blur();" class="pop_button"><span>新增</span></a>
					<a href="###" onclick="doEdit('${ctx}/bmp/workbench-demo/contactAndKnowStateSecrets/contactAndKnowStateSecrets_edit.jsp');this.blur();" class="pop_button"><span>编辑</span></a>
						...
						<table id="keySectionlist_table" border="0" cellspacing="0"
							...
							<thead>
								<tr>
									...
									<td class="tableHeader" width="10%">发文机关</td>
									<td class="tableHeader" width="10%">数量</td>
									<td class="tableHeader" width="10%">类型</td>
									<td class="tableHeader" width="10%">人员姓名</td>
									<td class="tableHeader" width="10%">时间</td>
									<td class="tableHeader" width="10%">承办人</td>
									<td class="tableHeader" width="10%">审批领导</td>
