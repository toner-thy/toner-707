						...
						<table class="content_table" width="100%">
							<tr>
								...
								<td class="tbValue fl" colspan="3">
									<input type="text" size="50" value="接触和知悉绝密级商业秘密文件人员情况"/><span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									<input type="text" value="四川省国家保密局"/>
								...
								<td class="tbValue fl">
									<input type="text" readonly="readonly" class="Wdate" value="2014-06-26" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" readonly="readonly" class="Wdate" value="2014-06-28" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
								<td class="tbLable fr">
									数量：
							...
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" readonly="readonly" value="2014-07-15 13:54:40" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
