	...
	<body>
		...
		<div id="body_content" class="body_content">
			...
			<cp:start defaultTitle="装备保密技术防范设备情况简介" ctx="${ctx}" icoPath="#">
				<div id="cp001Btn" class="cpBtn_ov" href="###" onmouseover="javascript:showCp(1,'cp001','装备保密技术防范设备情况简介');">关 于</div>
			</cp:start>
						...
						<table class="content_table" width="100%">
							<tr>
								...
								<td class="tbValue fl" colspan="3">
									<input type="text" size="50" value="保密机柜"/><span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl">
									<input type="text" value="1台" size="50"/><span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
								<td class="tbLable fr">
									时间：
								</td>
								<td class="tbValue fl">
									<input type="text" readonly="readonly" value="2012-3-14 13:20:55" class="Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
							...
							<tr>
								...
								<td class="tbValue fl" colspan="3">
									<input type="text" value="存放保密文件" size="50"/><span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
						</table>
						<!-- 隐藏提交按钮 -->
