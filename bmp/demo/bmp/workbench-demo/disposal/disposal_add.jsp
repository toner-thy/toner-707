					...
					<form id="add_form" action="<s:url namespace='/secrecyorganization/secrecyoffice' action='secrecyOffice_adding' includeParams='true'/>" method="post">
						<table class="content_table" width="100%">
							<tr>
								...
								<td class="tbValue fl">
									<s:select list="#{0:'请选择',1:'涉密计算机',2:'涉密传真机',3:'涉密复印机',4:'涉密扫描仪',5:'涉密刻录机',6:'涉密打印机',7:'涉密移动硬盘',8:'涉密U盘',9:'涉密光盘' }" theme="simple" cssStyle="width:135px;"></s:select>
							...
							<tr>
								...
								<td class="tbValue fl">
									<s:select list="#{0:'请选择',1:'秘密',2:'机密',3:'绝密' }" theme="simple" cssStyle="width:135px;"></s:select>
									<span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
