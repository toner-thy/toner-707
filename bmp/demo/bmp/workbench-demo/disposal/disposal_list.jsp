...
<script type="text/javascript">
	...
	function doDetail() {
		$ENV.dialog.open({
					url : "${ctx}/bmp/workbench-demo/disposal/disposal_detail.jsp?_ts=" + new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '详情'
				});
	...
	<div class="button_bar">
		<div class="left">
			<div class="pop_button_bar">
				<div class="pop_button_bar">
					<a href="###" onclick="doAdd('${ctx}/bmp/workbench-demo/disposal/disposal_add.jsp');this.blur();" class="pop_button"><span>新增</span></a>
					<a href="###" onclick="doEdit('${ctx}/bmp/workbench-demo/disposal/disposal_edit.jsp');this.blur();" class="pop_button"><span>编辑</span></a>
	...
	<div class="body_content">
		...
		<div class="panel">
			<div id="cpPanel" style="width: 100%;">
				<!-- 切换按钮 -->
				<div class="cpBtnBar">
					<div id="cp001Btn" class="cpBtn_ov" href="###" onmouseover="javascript:showCp(2,'cp001','涉密载体销毁、涉密办公设备报废情况简介');">关 于</div>
					<div id="cp002Btn" class="cpBtn" href="###" onmouseover="javascript:showCp(2,'cp002','涉密载体销毁、涉密办公设备报废情况查询');">查 询</div>
				</div>
				<!-- 切换面板 -->
						...
						<tr>
							...
							<td width="*" valign="top">
								<div id="cp001"
									...
									<!-- 模块简介 -->
									<div class="cpMsgTitle">关于涉密载体销毁、涉密办公设备报废情况</div>
									<div class="cpMsgContext">
										涉密载体销毁、涉密办公设备报废情况 涉密载体销毁、涉密办公设备报废情况
									</div>
									<!-- 上下之间的间隔，可以调节高度 -->
								...
								<div id="cp002"
									...
									<form method="post" id="queryform">
										<table class="st" width="100%">
											<tr>
												<td class="tbLable fr">涉密载体形式：</td>
												<td class="tbValue fl">
													<s:select list="#{1:'涉密计算机',2:'涉密传真机',3:'涉密复印机',4:'涉密扫描仪',5:'涉密刻录机',6:'涉密打印机',7:'涉密移动硬盘',8:'涉密U盘',9:'涉密光盘' }" theme="simple"></s:select>
												</td>
												<td class="tbLable fr">经办人：</td>
												<td class="tbValue fl">
													<input type="text" />
												</td>
											</tr>
		...
		<div class="panel tMargin">
			<div class="panel_header">
				<div class="panel_title panel_titleListIco">涉密载体销毁、涉密办公设备报废情况列表</div>
						...
						<table id="keySectionlist_table" border="0" cellspacing="0"
							...
							<thead>
								<tr>
									...
									<td class="tableHeader" width="10%">涉密载体形式（含报废涉密设备）</td>
									<td class="tableHeader" width="10%">涉密载体内容</td>
									<td class="tableHeader" width="10%">数量</td>
									<td class="tableHeader" width="10%">密级</td>
									<td class="tableHeader" width="10%">销毁、报废流向</td>
									<td class="tableHeader" width="10%">经办人</td>
