...
<script type="text/javascript">
	...
	function doDetail() {
		$ENV.dialog.open({
					url : "${ctx}/bmp/workbench-demo/education/education_detail.jsp?_ts=" + new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '详情'
				});
	...
	<div class="button_bar">
		<div class="left">
			<div class="pop_button_bar">
				<div class="pop_button_bar">
					<a href="###" onclick="doAdd('${ctx}/bmp/workbench-demo/education/education_add.jsp');this.blur();" class="pop_button"><span>新增</span></a>
					<a href="###" onclick="doEdit('${ctx}/bmp/workbench-demo/education/education_edit.jsp');this.blur();" class="pop_button"><span>编辑</span></a>
	...
	<div class="body_content">
		...
		<div class="panel tMargin">
			<div class="panel_header">
				<div class="panel_title panel_titleListIco">开展保密宣传教育、培训情况列表</div>
						...
						<table id="keySectionlist_table" border="0" cellspacing="0"
							...
							<thead>
								<tr>
									...
									<td class="tableHeader" width="10%">形式</td>
									<td class="tableHeader" width="10%">范围</td>
