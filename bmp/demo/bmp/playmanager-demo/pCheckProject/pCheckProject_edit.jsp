...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function doSave(){
				window.location.href = "${ctx}/bmp/playmanager-demo/pCheckProject/pCheckProject_list.jsp";
			}
		</script>
	</head>
					...
					<form id="add_form" action="<s:url namespace='/secrecyorganization/secrecyoffice' action='secrecyOffice_adding' includeParams='true'/>" method="post">
						<table class="content_table" width="100%">
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" name="" value="要害部门检查" />
