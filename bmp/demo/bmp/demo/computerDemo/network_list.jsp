	...
	<head>
		...
		<script type="text/javascript">
			...
			function doAdd(action){
				window.location.href = "${ctx}/bmp/demo/computerDemo/network_add.jsp";
			}
			...
			function doDetail(){
				$ENV.dialog.open({
					url : "http://192.168.1.34:8080/bmp/bmp/demo/computerDemo/network_zhongduan_list.jsp?_ts="+new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '涉密网络终端详情'
				});
		...
		<div class="button_bar">
			<div class="left">
				<div class="pop_button_bar">
					<div class="pop_button_bar"><a href="###"  onclick="doAdd('/bmp/bmp/keySection/keySection_add.action');this.blur();" class="pop_button"><span>新增</span></a><a href="###"  onclick="doEdit('/bmp/bmp/keySection/keySection_edit.action');this.blur();" class="pop_button"><span>编辑</span></a><a href="###"  onclick="doDel('/bmp/bmp/keySection/keySection_delete.action');this.blur();" class="pop_button"><span>删除</span></a></div>
				</div>
			</div>
			<div class="right">
				<div class="pop_button_bar">
...
<table id="keySectionlist_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="100%" >
	...
	<tr>
		...
		<td class="tableHeader"  width="10%" >涉密网络名称</td>
		<td class="tableHeader"  width="10%" >网络密级</td>
		<td class="tableHeader"  width="10%" >网络类型</td>
		<td class="tableHeader"  width="10%" >网络终端数量</td>
		<td class="tableHeader"  width="10%" >是否通过测评</td>
		<td class="tableHeader"  width="15%" >是否通过审批</td>
		<td class="tableHeader"  width="20%" >投入使用时间</td>
		<td class="tableHeader"  width="10%" >部门名称</td>
		<td class="tableHeader"  width="10%" >网络终端</td>
	</tr>
	</thead>
	...
	<tr class="odd"  onmouseover="this.className='highlight'"  onmouseout="this.className='odd'" >
		...
		<td width="10%" >是</td>
		<td width="15%" >是</td>
		<td width="20%" >2010-10-07</td>
		<td width="10%" >四川省国家保密局</td>
		<td width="10%" >
			<a title="查看详情" href="javaScript:doDetail()">
				<img src="${ctx}/platform/theme/borderlayout/skin/blue/img/btn/display.gif" border="0" title="详细信息"/>
			</a>
		</td>
	</tbody>
</table>
