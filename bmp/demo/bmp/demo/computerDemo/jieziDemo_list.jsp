	...
	<head>
		...
		<script type="text/javascript">
			...
			function doAdd(action){
				window.location.href = "${ctx}/bmp/demo/computerDemo/jieziDemo_add.jsp";
			}
...
<table id="keySectionlist_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="100%" >
	...
	<tr>
		...
		<td class="tableHeader"  width="10%" >介质类型</td>
		<td class="tableHeader"  width="10%" >类型描述</td>
		<td class="tableHeader"  width="10%" >密级</td>
		<td class="tableHeader"  width="10%" >责任人</td>
		<td class="tableHeader"  width="10%" >编号</td>
		<td class="tableHeader"  width="15%" >序列号</td>
		<td class="tableHeader"  width="20%" >是否属于要害部门、部位</td>
