...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function doSave(){
				window.location.href = "${ctx}/bmp/demo/computerDemo/networkZhongDuan_list.jsp";
			}
	...
	<body>
		...
		<div id="body_content" class="body_content">
			<!-- 复合面板开始 -->
			<cp:start defaultTitle="涉密网络终端简介" ctx="${ctx}" icoPath="#">
				<div id="cp001Btn" class="cpBtn_ov" href="###" onmouseover="javascript:showCp(1,'cp001','涉密网络终端简介');">关 于</div>
			</cp:start>
					...
					<form id="add_form" action="<s:url namespace='/secrecyorganization/secrecyoffice' action='secrecyOffice_adding' includeParams='true'/>" method="post">
						<table class="content_table" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl">
									<s:select list="#{'1':'台式','2':'便携式','3':'服务器'}"
									style="width:135px;"
									theme="simple"
									name=""
									>
