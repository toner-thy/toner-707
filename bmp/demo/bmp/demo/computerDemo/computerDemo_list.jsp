	...
	<head>
		...
		<script type="text/javascript">
			...
			function doAdd(action){
				window.location.href = "${ctx}/bmp/demo/computerDemo/computerDemo_add.jsp";
			}
		...
		<div class="button_bar">
			<div class="left">
				<div class="pop_button_bar">
					<div class="pop_button_bar">
					<a href="###"  onclick="doAdd('/bmp/bmp/keySection/keySection_add.action');this.blur();" class="pop_button"><span>新增</span></a>
					<a href="###"  onclick="doEdit('/bmp/bmp/keySection/keySection_edit.action');this.blur();" class="pop_button"><span>编辑</span></a>
					<a href="###"  onclick="doDel('/bmp/bmp/keySection/keySection_delete.action');this.blur();" class="pop_button"><span>删除</span></a>
					<a href="###"  onclick="" class="pop_button"><span>接入网络</span></a>
					<a href="###"  onclick="" class="pop_button"><span>移出网络</span></a>
					</div>
				</div>
			</div>
			<div class="right">
...
<table id="keySectionlist_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="100%" >
	...
	<tr>
		...
		<td class="tableHeader"  width="10%" >责任人</td>
		<td class="tableHeader"  width="10%" >密级</td>
		<td class="tableHeader"  width="10%" >机型</td>
		<td class="tableHeader"  width="10%" >编号</td>
		<td class="tableHeader"  width="10%" >硬盘序列号</td>
		<td class="tableHeader"  width="15%" >是否属于要害部门、部位</td>
		<td class="tableHeader"  width="20%" >是否安装保密技术防护专用系统（三合一）</td>
		<td class="tableHeader"  width="10%" >是否纳入违规外联监控系统</td>
	</tr>
	</thead>
	...
	<tr class="odd"  onmouseover="this.className='highlight'"  onmouseout="this.className='odd'" >
		...
		<td width="10%" >秘密</td>
		<td width="10%" >台式</td>
		<td width="10%" >ck8i-001</td>
		<td width="10%" >fdsaljx98x</td>
		<td width="15%" >是</td>
		<td width="20%" >是</td>
		<td width="10%" >是</td>
	</tbody>
