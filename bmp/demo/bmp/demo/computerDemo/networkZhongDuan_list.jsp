	...
	<head>
		...
		<script type="text/javascript">
			...
			function doAdd(action){
				window.location.href = "${ctx}/bmp/demo/computerDemo/networkZhongDuan_add.jsp";
			}
			...
			function doDetail(id){
				$ENV.dialog.open({
					url : "/bmp/bmp/keySection/keySection_detail.action?keySection.keySectionId=" + id + "&_ts="+new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '涉密网络终端详情'
				});
		...
		<div class="button_bar">
			<div class="left">
				<div class="pop_button_bar">
					<%-- <div class="pop_button_bar"><a href="###"  onclick="doAdd('/bmp/bmp/keySection/keySection_add.action');this.blur();" class="pop_button"><span>新增</span></a>
					<a href="###"  onclick="doEdit('/bmp/bmp/keySection/keySection_edit.action');this.blur();" class="pop_button"><span>编辑</span></a>
					<a href="###"  onclick="doDel('/bmp/bmp/keySection/keySection_delete.action');this.blur();" class="pop_button"><span>删除</span></a></div> --%>
				</div>
			</div>
			<div class="right">
				<div class="pop_button_bar">
		...
		<div class="body_content">
			...
			<div class="panel">
				<div id="cpPanel" style="width:100%;">
					<!-- 切换按钮 -->
					<div class="cpBtnBar">
						<div id="cp001Btn" class="cpBtn_ov" href="###" onmouseover="javascript:showCp(2,'cp001','涉密网络终端简介');">关 于</div>
						<div id="cp002Btn" class="cpBtn" href="###" onmouseover="javascript:showCp(2,'cp002','涉密网络终端查询');">查 询</div>
					</div>
					<!-- 切换面板 -->
...
<table id="keySectionlist_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="100%" >
	<thead>
	<tr>
		<td class="tableHeader"  ><input type="checkbox"  name="keySectionId_checkbox"  id="keySectionId_checkbox"  class="class_keySectionId_checkbox"  onclick="EcTable.checkAll('keySectionId_checkbox')" /></td>
		<td class="tableHeader"  >涉密网络名称</td>
		<td class="tableHeader"  >责任人</td>
		<td class="tableHeader"  >密级</td>
		<td class="tableHeader"  >机型</td>
		<td class="tableHeader"  >编号</td>
		<td class="tableHeader"  >硬盘序列号</td>
		<td class="tableHeader"   >IP地址</td>
		<td class="tableHeader"  >MAC地址</td>
		<td class="tableHeader" width="5%"  >是否属于要害部门、部位</td>
		<td class="tableHeader"  width="5%" >是否安装保密技术防护专用系统（三合一）</td>
		<td class="tableHeader" width="5%" >是否纳入违规外联监控系统</td>
