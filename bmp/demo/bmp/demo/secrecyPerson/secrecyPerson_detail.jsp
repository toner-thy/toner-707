...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			// 返 回
			function doBackToSecrecyPersonList(id){
				window.location.href = "${ctx}/bmp/demo/secrecyPerson/secrecyPerson_list.jsp";
			}
		</script>
		...
		<div class="button_bar">
			<div class="left">
				<div class="pop_button_bar">
					<a class="pop_button" href="###" onclick="doBackToSecrecyPersonList()"><span>保 存</span></a>
					<a class="pop_button" href="###" onclick="doBackToSecrecyPersonList()"><span>返回列表</span></a>
				</div>
			</div>
			<div class="right">
				<div class="pop_button_bar">
					...
					<table class="content_table st" width="100%">
						...
						<tr>
							...
							<td class="tbLable fl" colspan="3">
								<textarea style="width: 90%;padding: 5px;" rows="10"></textarea><br/>
						...
						<tr>
							...
							<td class="tbLable fl" colspan="3">
								<textarea style="width: 90%;padding: 5px;" rows="5"></textarea><br/>
