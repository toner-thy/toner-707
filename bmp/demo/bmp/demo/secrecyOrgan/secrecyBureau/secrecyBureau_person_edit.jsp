				...
				<div class="panel_content panel_content_table">
					<table class="content_table st" width="100%">
						...
						<tr>
							...
							<td class="tbValue fl">
								<input type="text" value="5131011972051643">
							</td>
						</tr>
						<tr>
							<td class="fr">
						...
						<tr>
							...
							<td class="fl">
								<input type="text" value="技术处">
							</td>
							<td class="fr">
								职 务：
							</td>
							<td class="fl">
								<input type="text" value="处长">
							</td>
						</tr>
						<tr>
							<td class="fr">
						...
						<tr>
							...
							<td class="fl">
								<input type="text" value="028-8637620">
							</td>
							<td class="tbLable fr">
								手 机：
							</td>
							<td class="tbValue fl">
								<input type="text" value="13594837205">
							</td>
						</tr>
						<tr>
							<td class="fr">
						...
						<tr>
							...
							<td class="tbLable fl" colspan="3" valign="top" height="50">
								<textarea style="width: 90%;padding: 5px;" rows="5">刘禹锡个人简历...........</textarea>
							</td>
						</tr>
					</table>
				</div>
