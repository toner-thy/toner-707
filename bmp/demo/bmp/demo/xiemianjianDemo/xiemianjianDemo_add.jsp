...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function doSave(){
				window.location.href = "${ctx}/bmp/demo/xiemianjianDemo/xiemianjianDemo_list.jsp";
			}

			function doAdd(){
				window.location.href = "${ctx}/bmp/demo/xiemianjianDemo/xiemianjianDemo_deal_add.jsp";
			}
			function doEdit(){
				window.location.href = "${ctx}/bmp/demo/xiemianjianDemo/xiemianjianDemo_deal_add.jsp";
			}
						...
						<table class="content_table" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl">
									...
									'6':'其他',
									'7':'非法获取、持有国家秘密载体泄密',
									'8':'买卖、转送或私自销毁国家秘密载体泄密',
									'9':'通过普通邮政、快递等无保密措施的渠道传递国家秘密载体泄密',
									'10':'邮寄、托运国家秘密载体出境，或者未经批准携带、传递国家秘密载体出境泄密',
									'11':'非法复制、记录、存储国家秘密泄密',
									'12':'私人交往和通信泄密',
									'13':'出版宣传工作泄密',
									'14':'丢失被盗泄密',
			...
			<div class="panel tMargin">
				<div class="panel_header no_print" style="position:fixed;">
					...
					<div class="pop_button_bar" style="float:right;">
							...
							<%-- <a href="###" id="doSecrecyChange" class="pop_button"><span>密级变更</span></a>
							<a href="###" id="doSecrecyClear" class="pop_button"><span>解除</span></a> --%>
					</div>
				</div>
