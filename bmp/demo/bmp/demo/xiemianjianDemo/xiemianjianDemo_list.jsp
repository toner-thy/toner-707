	...
	<head>
		...
		<script type="text/javascript">
			...
			function doDetail(id){
				$ENV.dialog.open({
					url : "/bmp/bmp/demo/xiemianjianDemo/xiemianjianDemo_detail.jsp?_ts="+new Date().getTime(),
					width : 0.8,
					height : 0.9,
					title : '泄露案件详情'
				});
		...
		<div class="button_bar">
			<div class="left">
				<div class="pop_button_bar">
					...
					<%-- <a href="###"  onclick="doDeal('/bmp/bmp/keySection/keySection_delete.action');this.blur();" class="pop_button"><span>处理</span></a> --%>
					</div>
				</div>
			</div>
			<div class="right">
		...
		<div class="body_content">
			...
			<div class="panel">
				<div id="cpPanel" style="width:100%;">
					<!-- 切换按钮 -->
					<div class="cpBtnBar">
						<div id="cp001Btn" class="cpBtn_ov" href="###" onmouseover="javascript:showCp(2,'cp001','泄露案件简介');">关 于</div>
						<div id="cp002Btn" class="cpBtn" href="###" onmouseover="javascript:showCp(2,'cp002','泄露案件查询');">查 询</div>
					</div>
					<!-- 切换面板 -->
