	...
	<head>
		...
		<script type="text/javascript">
			...
			function doDetail(id){
				$ENV.dialog.open({
					url : '${ctx}/bmp/demo/keyDepartment/keyDepartment_detail.jsp',
	...
	<body>
		...
		<div class="button_bar">
			<div class="left">
				<div class="pop_button_bar">
					<a class="pop_button" href="keyDepartment_add.jsp" onclick=""><span>新 增</span></a>
					<a class="pop_button" href="keyDepartment_edit.jsp" onclick=""><span>编 辑</span></a>
		...
		<div class="body_content">
			<cp:start defaultTitle="保密要害部门简介" ctx="${ctx}" icoPath="/bmp/demo/keyDepartment/list_cpIco.gif">
				...
				<div id="cp002Btn" class="cpBtn" href="###" onmouseover="javascript:showCp(2,'cp002','保密要害部门搜索');">查 询</div>
			</cp:start>
