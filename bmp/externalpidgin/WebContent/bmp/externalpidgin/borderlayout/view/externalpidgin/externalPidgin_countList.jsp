		...
		<div id="body_content" class="body_content">
			<div class="panel">
				...
				<div class="panel_content panel_content_table">	
					<s:form action="externalPidgin_countExternalPidgin" id="externalPidgin_count_list_form" theme="simple">
						<table>
							<tr>
								<td class="widthTD">
					...
					<tbody class="tableBody">
						...
						<c:forEach items="${list}" var="e">
							<tr align="center">
								...
								<td>
									<c:if test="${e[2] != 0}">
										<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.organName=${e[1]}&externalPidginDto.externalPidgin.secrecyLevel=1">${e[2]}</a>		
									</c:if>
									<c:if test="${e[2] == 0}">${e[2]}</c:if>
								</td>
								<td>
									<c:if test="${e[3] != 0}">
										<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.organName=${e[1]}&externalPidginDto.externalPidgin.secrecyLevel=2">${e[3]}</a>		
									</c:if>
									<c:if test="${e[3] == 0}">${e[3]}</c:if>
								</td>
								<td>
									<c:if test="${e[4] != 0}">
										<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.organName=${e[1]}&externalPidginDto.externalPidgin.secrecyLevel=3">${e[4]}</a>		
									</c:if>
									<c:if test="${e[4] == 0}">${e[4]}</c:if>
								</td>
								<td>
									<c:if test="${e[5] != 0}">
										<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.organName=${e[1]}&externalPidginDto.externalPidgin.secrecyLevel=4">${e[5]}</a>		
									</c:if>
									<c:if test="${e[5] == 0}">${e[5]}</c:if>
								</td>
								<td>
									<c:if test="${e[6] != 0}">
										<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.organName=${e[1]}&externalPidginDto.externalPidgin.secrecyLevel=5">${e[6]}</a>		
									</c:if>
									<c:if test="${e[6] == 0}">${e[6]}</c:if>
								</td>
								<td>
									<c:if test="${e[7] != 0}">
										<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.organName=${e[1]}&externalPidginDto.externalPidgin.secrecyLevel=6">${e[7]}</a>		
									</c:if>
								...
								<td>
									...
									<c:if test="${(e[2]+e[3]+e[4]+e[5]+e[6]+e[7]) ge 1}">
										<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.organName=${e[1]}&externalPidginDto.externalPidgin.secrecyLevel=100">
						...
						<tr align="center">
							...
							<td>
							<c:if test="${sum1 != 0}">
								<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.externalPidgin.secrecyLevel=1&organNames=${organName}">${sum1 }</a>		
							</c:if>
							<c:if test="${sum1 == 0 }">
								${sum1 }
							</c:if>
							...
							<td>
							<c:if test="${sum2 != 0}">
								<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.externalPidgin.secrecyLevel=2&organNames=${organName}">${sum2 }</a>		
							</c:if>
							<c:if test="${sum2 == 0 }">
								${sum2 }
							</c:if>
							...
							<td>
							<c:if test="${sum3 != 0}">
								<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.externalPidgin.secrecyLevel=3&organNames=${organName}">${sum3 }</a>		
							</c:if>
							<c:if test="${sum3 == 0 }">
								${sum3 }
							</c:if>
							...
							<td>
							<c:if test="${sum4 != 0}">
								<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.externalPidgin.secrecyLevel=4&organNames=${organName}">${sum4 }</a>		
							</c:if>
							<c:if test="${sum4 == 0 }">
								${sum4 }
							</c:if>
							...
							<td>
							<c:if test="${sum5 != 0}">
								<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.externalPidgin.secrecyLevel=5&organNames=${organName}">${sum5 }</a>		
							</c:if>
							<c:if test="${sum5 == 0 }">
								${sum5 }
							</c:if>
							...
							<td>
							<c:if test="${sum6 != 0}">
								<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.externalPidgin.secrecyLevel=6&organNames=${organName}">${sum6 }</a>		
							</c:if>
							<c:if test="${sum6 == 0 }">
								${sum6 }
							</c:if>
							...
							<td>
							<c:if test="${sum7 != 0}">
								<a href="externalPidgin_organEpList.action?countType=${countType}&externalPidginDto.externalPidgin.secrecyLevel=1000&organNames=${organName}">${sum7 }</a>		
							</c:if>
							<c:if test="${sum7 == 0 }">
								${sum7 }
							</c:if>
