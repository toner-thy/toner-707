		...
		<div id="body_content" class="body_content" style="width:99%;">
			...
			<div class="panel tMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="add_form" action="<s:url namespace='/bmp/notice' action='notice_editing' includeParams='true'/>" method="post">
						<!-- 隐藏域 -->
						...
						<table class="content_table">
							...
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" id="title" name="notice.noticePublishDate" readonly="readonly" value="<fmt:formatDate pattern='yyyy-MM-dd' value='${notice.noticePublishDate}'/>" onFocus="WdatePicker()" class="Wdate validate['required']" /> <span style="color:red;">*</span>
								</td>
							</tr>
							<tr>
