...
<html>
	<head>
		...
		<script type="text/javascript">
 			...
 			function doSectionView1(id,secrecyLevel){
 				var titleText = "保密要害部门撰取-列表";
 				if(secrecyLevel=="-1") {
 					titleText = "保密要害部门合计-列表";
 				}
 				TabUtil.openAsTab({
 					url : '${ctx}/bmp/keySection/keySection_organSectionData.action?organId='+id+'&secrecyLevel='+secrecyLevel+'&t_date='+ new Date().getTime(),
 					title : titleText
 				});
 			}
									...
									<tr>
										...
										<td class="td_content_right">
											...
											<c:if test="${keySectionArgs[2] ne 0}">
												<a href="###" onclick="doSectionView1('${organ.organId}','3')">
													${keySectionArgs[2]}
												</a>
											</c:if>
										</td>
									...
									<tr>
										...
										<td class="td_content_right">
											...
											<c:if test="${keySectionArgs[1] ne 0}">
												<a href="###" onclick="doSectionView1('${organ.organId}','2')">
													${keySectionArgs[1]}
												</a>
											</c:if>
										</td>
									...
									<tr>
										...
										<td class="td_content_right">
											...
											<c:if test="${keySectionArgs[0] ne 0}">
												<a href="###" onclick="doSectionView1('${organ.organId}','1')">
													${keySectionArgs[0]}
												</a>
											</c:if>
										</td>
