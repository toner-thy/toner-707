		...
		<div class="panel_header no_print" >
			<div class="panel_title panel_titleListIco no_print">
				<div style="width: 100%; font-size:22px; padding-top: 10px; padding-bottom: 8px; font-weight: bold; font-family: '楷体_gb2312';" align="center">
					保密要害部门【${keySectionSecrecyClear.keySectionId.department.departmentName }】密级解除详情
				</div>
			</div>
		</div>
				...
				<div class="panel_content panel_content_table">
					<table class="content_table st" cellspacing="0" cellpadding="0" width="100%;">
						<tr>
							...
							<td class="tbValue fl" >
								<dictionary:text tableCode="bmp" fieldCode="clear_secrecy_type" optionValue="${keySectionSecrecyClear.clearType }"></dictionary:text>
							</td>
							<td class="tbLable fr" style="white-space: nowrap;">
								解除时间：
							</td>
							<td class="tbValue fl">
								<s:date name="keySectionSecrecyClear.clearTime" format="yyyy-MM-dd" />
							</td>
						</tr>
						<tr>
							<td class="tbLable fr" style="white-space: nowrap;">
						...
						<tr>
							...
							<td class="fl" colspan="3" >
								${keySectionSecrecyClear.cleanReason }
							</td>
						</tr>
					</table>
				</div>
