...
<html>
	<head>
		<title>保密要害部门统计(保密局)-统计要害部门的行政区划</title>
		...
		<script type="text/javascript">
			...
			function doExport3(){
				...
				frm.action = "${ctx}/bmp/keySection/exportExcel_KeySectionCount_District.action?districtCode=${districtCode}";
				frm.submit();
			}
			...
			<div class="panel tMargin" style="overflow:auto;">
				<div class="panel_header">
					...
					<div class="panel_btn_bar pop_button_bar">
						<a href="###" id="doExport"  onclick="doExport3()" class="pop_button"><span>导出</span></a>
					</div>
				</div>
