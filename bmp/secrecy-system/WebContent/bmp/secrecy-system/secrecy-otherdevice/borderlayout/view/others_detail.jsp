		...
		<script type="text/javascript">
			...
			function doChangeType(value){
				if(value == 1){
					...
					$('keysection_show2').set("text","${not empty secrecyOthers.keySection.keySectionId ? secrecyOthers.keySection.department.departmentName : ''}");
					...
					$('keypart_show2').set("text", "${not empty secrecyOthers.keyPart.partId ? secrecyOthers.keyPart.partName : ''}");
		...
		<div class="body_content">
			...
			<div class="panel tMargin bMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="form_secrecyOthers_add" action="<s:url namespace='/secrecysystem/secrecyOthers' action='mobilestoragemedia_editing' includeParams='true'/>" method="post">
						<!-- 隐藏域 -->
						...
						<table class="content_table" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl" colspan="3">
									${secrecyOthers.secrecyothersDescription }
								</td>
							</tr>
						</table>
			...
			<!-- 涉密人员panel结束 -->
			<div id="levelChangeList" name="levelChangeList" url="${ctx }/secrecysystem/secrecyothers/others_levalChangeDetail.action?secrecyOthers.secrecyothersId=${secrecyOthers.secrecyothersId}" ></div>
