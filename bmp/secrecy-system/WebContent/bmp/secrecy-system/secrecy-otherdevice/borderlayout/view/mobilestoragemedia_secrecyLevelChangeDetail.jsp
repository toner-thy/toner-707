...
<%-- 					<a class="pop_button pop_button_close" href="###" onclick="javascript:TabUtil.closeTab();"><span>退出本页</span></a> --%>
		...
		<div class="body_content">
			...
			<div class="panel tMargin bMargin">
				...
				<div id="levelChangeList" name="levelChangeList" url="${ctx }/secrecysystem/secrecymobilestoragemedia/mobilestoragemedia_levalChangeDetail.action?secrecyMobilestoragemediaChange.mobilestoragemediaChangeId=${secrecyMobilestoragemediaChange.mobilestoragemediaChangeId}" ></div>
				<div id="baseMsg" name="baseMsg" url="${ctx }/secrecysystem/secrecymobilestoragemedia/mobilestoragemedia_baseDetail.action?secrecyMobilestoragemedia.secrecymobilestoragemediaId=${secrecyMobilestoragemediaChange.secrecyMobilestoragemedia.secrecymobilestoragemediaId}" ></div>
