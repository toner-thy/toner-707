		...
		<!-- 内容panel开始 -->
			<div class="panel tMargin bMargin">
				...
				<div class="panel_content panel_content_table">
					<s:if test="#request.secrecyMobilestoragemediaClearList.size>0">
						<table class="content_table" width="100%">
							<c:forEach items="${secrecyMobilestoragemediaClearList }" var="clear">
								<tr>
									<td width="8%" align="right" nowrap="nowrap">
										原密级：
									</td>
									<td width="5%" align="left">
										<dictionary:text tableCode="bmp" fieldCode="secrecy_level_thing" optionValue="${clear.secrecyMobilestoragemedia.secrecyLevel}"></dictionary:text>
									</td>
