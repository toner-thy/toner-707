...
<!-- 复合面板开始 -->
			<cp:start defaultTitle="涉密移动存储介质简介" ctx="${ctx}" icoPath="/bmp/secrecy-system/secrecy-otherdevice/borderlayout/skin/blue/img/secrecyMobilestoragemedia_list_cpIco.gif">
				...
				<cp:search show="false" divId="cp002">
					<s:form namespace="/secrecysystem/secrecymobilestoragemedia" action="mobilestoragemedia_countData.action" method="post" id="queryForm" theme="simple">
						<input type="hidden" name="countType" id="countType" value="${countType }" />
						<input type="hidden" id="secrecyMobilestoragemedia.mediaType" name="secrecyMobilestoragemedia.mediaType" title="true" value="${secrecyMobilestoragemedia.mediaType }" />
					...
					<div class="panel tMargin">
						<s:if test="#attr.secrecyMobilestoragemediaList.size>0">
							<ec:table items="secrecyMobilestoragemediaList" var="secrecyMobilestoragemedia"
								...
								action="${ctx}/secrecysystem/secrecymobilestoragemedia/mobilestoragemedia_countData.action"
