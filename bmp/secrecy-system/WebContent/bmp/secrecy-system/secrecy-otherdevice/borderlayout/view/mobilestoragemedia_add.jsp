		...
		<script type="text/javascript">
			...
			function showKeysectionpart(value){
				if(value == 1){
					...
					$('secrecyMobilestoragemedia.department.departmentId').value = '';
					$('secrecyMobilestoragemedia.department.departmentName').value = '';
		...
		<div class="body_content">
			...
			<div class="panel tMargin bMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="form_secrecyMobilestoragemedia_add" action="<s:url namespace='/secrecysystem/secrecymobilestoragemedia' action='mobilestoragemedia_adding' includeParams='true'/>" method="post">
						<!-- 隐藏域 -->
