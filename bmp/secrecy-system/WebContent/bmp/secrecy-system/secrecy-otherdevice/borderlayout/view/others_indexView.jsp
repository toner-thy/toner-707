...
<html>
	<head>
		...
		<script type="text/javascript">
 			function doSecrecyOthersTotalView( secrecyothersType) {
 			...
 			function doSecrecyOthersCommonView(secrecyLevel, secrecyothersType){
															...
															<c:forEach var="aKeyValue" items="${aResultMap.value }">
																<c:if test="${aKeyValue.key eq typeOption.optionValue }">
																	<c:choose>
																		...
																		<c:otherwise>
																			<a href="###" onclick="doSecrecyOthersCommonView('${aResultMap.key }','${aKeyValue.key }')">
																				${aKeyValue.value}
																			</a>
																		</c:otherwise>
																	</c:choose>
									...
									<tr align="right">
										...
										<c:forEach var="typeOption" items="${typeList }" >
											<td class="td_total_right">
												...
												<c:otherwise>
													<a href="###" onclick="doSecrecyOthersTotalView('${typeOption.optionValue}')">
														${totalNum }
													</a>
												</c:otherwise>
											</c:choose>
