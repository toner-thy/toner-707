	...
	<body>
		...
		<div class="body_content">
			...
			<div class="panel tMargin bMargin">
				...
				<div id="levelChangeList" name="levelChangeList" url="${ctx }/secrecysystem/secrecyothers/others_levalChangeDetail.action?secrecyOthersChange.secrecyothersChangeId=${secrecyOthersChange.secrecyothersChangeId}" ></div>
				<div id="baseMsg" name="baseMsg" url="${ctx }/secrecysystem/secrecyothers/others_baseDetail.action?secrecyOthers.secrecyothersId=${secrecyOthersChange.secrecyOthers.secrecyothersId}" ></div>
