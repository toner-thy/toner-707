...
<html>
	<head>
		...
		<script type="text/javascript">
 			function doSecrecyMobilestorageTotalViewLayer( mediaType) {
 			...
 			function doSecrecyMobilestorageCommonViewLayer(secrecyLevel, mediaType){
															...
															<c:forEach var="aKeyValue" items="${aResultMap.value }">
																<c:if test="${aKeyValue.key eq typeOption.optionValue }">
																	<c:choose>
																		...
																		<c:otherwise>
																			<a href="###" onclick="doSecrecyMobilestorageCommonViewLayer('${aResultMap.key }','${aKeyValue.key }')">
																				${aKeyValue.value}
																			</a>
																		</c:otherwise>
																	</c:choose>
									...
									<tr align="right">
										...
										<c:forEach var="typeOption" items="${typeList }" >
											<td class="td_total_right">
												...
												<c:otherwise>
													<a href="###" onclick="doSecrecyMobilestorageTotalViewLayer('${typeOption.optionValue}')">
														${totalNum }
													</a>
												</c:otherwise>
											</c:choose>
