	...
	<head>
		...
		<script type="text/javascript">
			...
			function doView(id,secrecyLevel){
				...
				url : '${ctx}/bmp/secrecynetworkterminal/zhtj_DetailList.action?organId='+id+'&secrecyLevel='+secrecyLevel+'&district.districtCode='+${district.districtCode}+'&t_date=' + new Date().getTime(),
				width : 800,
				height : 550,
	...
	<body>
		<div class="button_bar">
			<div class="left">
			    ...
			    <a class="pop_button" href="${pageContext.request.contextPath}/bmp/secrecynetworkterminal/zhtj_query_Detail.action?district.districtCode=${district.districtCode}"><span>返回</span></a>
			</div>
			<div class="right">
			...
			<div class="panel tMargin">
				<div class="panel_header">
					<div class="panel_title panel_titleListIco">
						【${district.districtName }】行政区划涉密网络终端统计
					</div>
