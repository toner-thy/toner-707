		...
		<script type="text/javascript">
			...
			$ENV.loader.loadJavaScript("${ctx}/resources/js/formcheck/1.4/formcheck.js",function(){
				$ENV.onDomReady(function(){
					...
					var cp = $('secrecyNetwork.isReview' + '${secrecyNetwork.isReview}');
					cp.checked = "checked" ;
					selectPC('${secrecyNetwork.isReview}');
					var sp = $('secrecyNetwork.isApproval' + '${secrecyNetwork.isApproval}');
					sp.checked = "checked" ;
		...
		<div id="body_content" class="body_content">
			...
			<div class="panel tMargin bMargin">
				...
				<div class="panel_content panel_content_table">
					<form id="add_form" action="<s:url namespace='/bmp/secrecynetwork' action='secrecyNetwork_editing.action' includeParams='true'/>" method="post">
						...
						<table class="content_table" width="100%">
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" id="secrecyNetwork.name" name="secrecyNetwork.name" class="validate['required','length[100]']" value="${secrecyNetwork.name }" style="width: 70%"/><span style="color:red;">&nbsp;&nbsp;*</span>
								...
								<td class="tbValue fl">
									<dep:selectByOrgan valueEl="secrecyNetwork.department.departmentId" textEl="secrecyNetwork.department.departmentName"
										required="true" onlyFromValue="false" value="${secrecyNetwork.department.departmentId }" buttonEl="dept_img"/>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
							...
							<tr>
								...
								<td class="tbValue fl">
								  	<input type="radio" id="secrecyNetwork.isReview1" name="secrecyNetwork.isReview"  value="1" onclick="selectPC(this.value)">是
									<input type="radio" id="secrecyNetwork.isReview0" name="secrecyNetwork.isReview" value="0" onclick="selectPC(this.value)">否
								...
								<td class="tbValue fl">
									<input type="radio" id="secrecyNetwork.isApproval1" name="secrecyNetwork.isApproval"  value="1" onclick="selectSP(this.value)">是
									<input type="radio" id="secrecyNetwork.isApproval0" name="secrecyNetwork.isApproval" value="0" onclick="selectSP(this.value)">否
							        <span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							...
							<tr style="display: none;" id="pass11">
								...
								<td class="tbValue fl">
									<input type="text" name="secrecyNetwork.reviewTime" id="secrecyNetwork.reviewTime" value="<s:date name='#attr.secrecyNetwork.reviewTime' format='yyyy-MM-dd'/>"
								...
								<td class="tbValue fl">
								    <org:selectByDistrct textEl="secrecyNetwork.reviewOrgan.organName" valueEl="secrecyNetwork.reviewOrgan.organId" value="${secrecyNetwork.reviewOrgan.organId }" required="false" buttonEl="orgImg"></org:selectByDistrct>
								</td>
							</tr>
							<tr style="display: none;" id="pass22">
								...
								<td class="tbValue fl">
									<input type="text" name="secrecyNetwork.approvalTime" id="secrecyNetwork.approvalTime" value="<s:date name='#attr.secrecyNetwork.approvalTime' format='yyyy-MM-dd'/>"
										class="Wdate" onFocus="WdatePicker();" readonly="readonly" />
								</td>
								<td class="tbLable fr">
									审批文号：
								...
								<td class="tbValue fl">
								    <input type="text" id="secrecyNetwork.approvalNo" name="secrecyNetwork.approvalNo" value="${secrecyNetwork.approvalNo }">
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
								...
								<td class="tbValue fl" colspan="3">
									<input type="text" id="secrecyNetwork.startUseDate" name="secrecyNetwork.startUseDate" class="Wdate validate['required'] w135" value="<s:date name='#attr.secrecyNetwork.startUseDate' format='yyyy-MM-dd'/>" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly" /><span style="color:red;">&nbsp;&nbsp;*</span>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
