		...
		<script type="text/javascript">
			function doSave(){
				...
				//判断  现密级的填写情况 ，不能和原密级一样
					var yuan_mi_ji = $('secrecyComputerChange.beforeLevel').value;
					var xian_mi_ji = $('secrecyComputerChange.afterLevel').value;
	...
	<body>
		<div class="panel tMargin" >
			<div class="panel_content panel_content_table">
				<form id="add_form" action="<s:url namespace='/bmp/secrecycomputer' action='secrecyComputer_secrecyChanging.action' includeParams='true'/>"
					...
					<table class="content_table st" cellspacing="0" cellpadding="0" width="100%;">
						<tr>
							...
							<td class="tbValue fl">
							    ...
							    <input type="hidden" id="secrecyComputerChange.beforeLevel" name="secrecyComputerChange.beforeLevel" value="${secrecyComputer.secrecyLevel}" />
								<input type="hidden" id="secrecyComputerChange.secrecyComputer.secrecycomputerId" name="secrecyComputerChange.secrecyComputer.secrecycomputerId" value="${secrecyComputer.secrecycomputerId}" />
							</td>
						</tr>
						...
						<tr>
							...
							<td class="tbValue fl">
								<dictionary:select tableCode="bmp" fieldCode="secrecy_limit" id="secrecyComputerChange.changeTimeState" name="secrecyComputerChange.changeTimeState"
									 title="false" style="width:130px;"></dictionary:select>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="tbValue fl">
								<input type="text" id="secrecyComputerChange.changeDate" name="secrecyComputerChange.changeDate" class="Wdate validate['required'] w130"
						...
						<tr>
							...
							<td class="tbValue fl">
								<textarea rows="5" cols="50" id="secrecyComputerChange.changeReason" name="secrecyComputerChange.changeReason" class="validate['length[2000]']"></textarea>
							</td>
						</tr>
