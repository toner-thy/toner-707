		...
		<div id="body_content" class="body_content">
			<div class="panel tMargin bMargin" >
				<div class="panel_content panel_content_table">
					<form id="add_form" action="<s:url namespace='/bmp/secrecynetworkterminal' action='secrecyNetworkterminal_remove.action' includeParams='true'/>"
						...
						<table class="content_table st" cellspacing="0" cellpadding="0" width="100%;">
							...
							<tr>
								...
								<td class="tbValue fl">
									<textarea rows="5" cols="50" id="secrecyNetworkterminal.removeNetworkReason" name="secrecyNetworkterminal.removeNetworkReason" class="validate['length[1000]']">${secrecyNetworkterminal.removeNetworkReason }</textarea>
								</td>
							</tr>
						</table>
