...
<c:set var="ctx" value="${pageContext.request.contextPath}"/>
		...
		<script type="text/javascript">
			...
			//导出
			function doExportOthersLayer(){
				var frm = $('excel_othersLayer_form');
				frm.action = "${ctx}/secrecysystem/statistics/export_OthersLayer.action";
				frm.submit();
			}
		</script>
		<style type="text/css">
		...
		<div style="padding:5px;"  >
			...
			<div class="panel" style="overflow-y: auto;">
				<div class="panel_header">
					...
					<div class="panel_btn_bar pop_button_bar">
						<a href="###" id="doExport"  onclick="doExportOthersLayer()" class="pop_button"><span>导出</span></a>
					</div>
				</div>
			...
			<form action="" name="excel_othersLayer_form" id="excel_othersLayer_form" enctype="application/x-www-form-urlencoded">
			</form>
		</div>
