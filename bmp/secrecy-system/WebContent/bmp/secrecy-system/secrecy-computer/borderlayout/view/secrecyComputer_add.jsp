		...
		<script type="text/javascript">
			...
			function showKeysectionpart(value){
				if(value == 1){
					...
					$('secrecyComputer.department.departmentId').value = '';
					$('secrecyComputer.department.departmentName').value = '';
						...
						<table class="content_table" width="100%">
							...
							<tr>
								...
								<td class="tbValue fl">
									...
									<%-- <sp:selectSecrecyPerson valueEl="secrecyComputer.dutyPerson.userInfoId" textEl="secrecyComputer.dutyPerson.name" buttonEl="secrecyPersonName" /> --%>
							...
							<tr>
								...
								<td class="tbValue fl">
									<input type="text" id="secrecyComputer.computerNo" name="secrecyComputer.computerNo" class="validate['required','length[100]']"/><span style="color:red;">&nbsp;&nbsp;*</span>
									<img alt="" src="${ctx}/bmp/key-section/borderlayout/skin/blue/img/wen.jpg" width="20px" height="20px;"
								...
								<td class="tbValue fl">
									<input type="text" id="secrecyComputer.diskSeq" name="secrecyComputer.diskSeq"  class="validate['required','length[100]']"/><span style="color:red;">&nbsp;&nbsp;*</span>
								</td>
							</tr>
							<tr>
								<td class="tbLable fr">
