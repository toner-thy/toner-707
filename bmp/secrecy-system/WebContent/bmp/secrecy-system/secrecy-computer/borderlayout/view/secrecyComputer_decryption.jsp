	...
	<body>
		<div class="panel tMargin" >
			<div class="panel_content panel_content_table">
				<form id="add_form" action="<s:url namespace='/bmp/secrecycomputer' action='secrecyComputer_decryptioning.action' includeParams='true'/>"
					...
					<table class="content_table st" cellspacing="0" cellpadding="0" width="100%;">
						<tr>
							...
							<td class="tbValue fl">
								...
								<input type="hidden" id="secrecyComputerClear.secrecyComputer.secrecycomputerId" name="secrecyComputerClear.secrecyComputer.secrecycomputerId" value="${secrecyComputer.secrecycomputerId}" />
							</td>
						</tr>
						<tr>
							<td class="tbLable fr">解除类型：</td>
							<td class="tbValue fl">
								<dictionary:select  id="secrecyComputerClear.clearType" name="secrecyComputerClear.clearType" tableCode="bmp" fieldCode="clear_secrecy_type"
						...
						<tr>
							...
							<td class="tbValue fl">
								<input type="text" id="secrecyComputerClear.clearTime" name="secrecyComputerClear.clearTime"
						...
						<tr>
							...
							<td class="tbValue fl">
								<textarea rows="5" cols="50" id="secrecyComputerClear.cleanReason" name="secrecyComputerClear.cleanReason" class="validate['length[2000]']"></textarea>
							</td>
						</tr>
					</table>
