...
<c:set var="ctx" value="${pageContext.request.contextPath}"/>
		...
		<script type="text/javascript">
			...
			//导出
			function doExportMobileStorageMediaCurrentOrgan(){
				var frm = $('excel_mobileStorageMediaCurrentOrgan_form');
				frm.action = "${ctx}/secrecysystem/statistics/export_MobileStorageMediaCurrentOrgan.action";
				frm.submit();
			}
		</script>
		<style type="text/css">
		...
		<div style="padding:5px;"  >
			...
			<div class="panel" style="overflow-y: auto;">
				<div class="panel_header">
					...
					<div class="panel_btn_bar pop_button_bar">
						<a href="###" id="doExport"  onclick="doExportMobileStorageMediaCurrentOrgan()" class="pop_button"><span>导出</span></a>
					</div>
				</div>
			...
			<form action="" name="excel_mobileStorageMediaCurrentOrgan_form" id="excel_mobileStorageMediaCurrentOrgan_form" enctype="application/x-www-form-urlencoded">
			</form>
		</div>
