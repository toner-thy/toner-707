 ...
 * @author
 */
public class SecrecyOthersDistrictListTableCollector implements ParameterCollector<List<DistrictListTable>>{
	...
	public List<DistrictListTable> getData(Parameter param) {
		...
		List<ZongHeTongJiStatDto> list = secrecyOthersService.count_SecrecyOthers_District(new ArrayList<District>(district.getChildren()), true);

		//设置表头
		DistrictListTable districtTable = new DistrictListTable();
		districtTable.setTotalText("其他涉密设备");
