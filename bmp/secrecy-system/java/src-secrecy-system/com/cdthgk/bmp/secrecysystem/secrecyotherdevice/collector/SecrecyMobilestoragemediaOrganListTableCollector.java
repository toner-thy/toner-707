 ...
 * @author
 */
public class SecrecyMobilestoragemediaOrganListTableCollector implements ParameterCollector<List<OrganListTable>>{
	...
	public List<OrganListTable> getData(Parameter param) {
		...
		List<ZongHeTongJiStatDto> statList = secrecyMobilestoragemediaService.count_SecrecyMobilestoragemedia_Organ(district,organ, false);

		// 设置头部  表格的第一排
		OrganListTable organTable = new OrganListTable();
		organTable.setOrganName("涉密移动存储介质");
