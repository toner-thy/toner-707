 ...
 * @author
 */
public class SecrecyOthersOrganListTableCollector implements ParameterCollector<List<OrganListTable>>{
	...
	public List<OrganListTable> getData(Parameter param) {
		...
		List<ZongHeTongJiStatDto> statList = secrecyOthersService.count_SecrecyOthers_Organ(district,organ, false);

		// 设置头部  表格的第一排
		OrganListTable organTable = new OrganListTable();
		organTable.setOrganName("其他涉密设备");
