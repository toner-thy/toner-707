...
<html>
		...
		$ENV.loader.loadJavaScript("${pageContext.request.contextPath}/resources/js/AscribeDialog/dialog.js", function(){
			...
			$ENV.onDomReady(function(){
				...
				var loadMessages = function() {
					new Request.JSON({
					    url: "${contextPath}/bmp/info/info_remind.action",
	...
	<body>
		<iframe id="home_container" name="home_container" frameborder="0" scrolling="no" src="${home}"></iframe>
		<%--
		<form id="home_container_form" action="${home}" method="post" target="home_container">
		<%
		...
		<script type="text/javascript">
		document.getElementById('home_container_form').submit();
		</script>
		 --%>
	</body>
</html>