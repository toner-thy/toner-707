	...
	<head>
		...
		$ENV.loader.loadJavaScript("${contextPath}/resources/js/AccordionMenu/AccordionMenu.js", function() {
			$ENV.onDomReady(function(){
				...
				<%-- 协同办公 --%>
				$('btn_xietong_bangong').addEvent('click', function(){
					window.open("http://74.2.74.75:5555/ServiceAction/j_acegi_security_check?userName=${uName}&encodedCode=${currentUser.password}");
				});
...
function showTutorial(type,idNew){
	...
	<body>
		...
		<div id="div_head" class="head">
			...
			<div class="button btn_xietong_bangong" id="btn_xietong_bangong">&nbsp;</div>
